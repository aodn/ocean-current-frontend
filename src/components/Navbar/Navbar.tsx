  ...
  return (
    <div className={cn('sticky top-0 z-50 w-full bg-white shadow-md transition-all duration-300', className)}>
      <nav
        ...
        className="max-w-8xl mx-auto flex w-full items-center justify-between gap-4 p-3 px-4 md:px-6 lg:px-10"
      >
        <div data-testid="navbar-branding" className="flex h-10 shrink-0 items-center lg:h-14">
          ...
          <div className="bg-imos-title-blue mx-3 h-10 w-0.5 opacity-50 lg:mx-7 lg:h-12" aria-hidden="true"></div>
          <div className="font-poppins text-imos-title-blue flex flex-col justify-center text-base font-light lg:text-xl">
        ...
        <div className="flex items-center justify-center text-black max-md:flex-wrap">
          <div
            ...
            className="text-imos-nav-text relative flex justify-between gap-3 self-start text-base leading-snug font-semibold max-md:max-w-full max-md:flex-wrap md:gap-8 lg:gap-12 xl:gap-20"
          >
            {menuItems.map((item, index) => (
              <div
                key={item.title}
                onMouseEnter={(event) => setPositionNavbar(index, event.currentTarget)}
                className="cursor-pointer py-3 whitespace-nowrap"
              >
                {item.url ? (
                  <LinkOrAnchor
                    to={item.url}
            ...
            {hoverIndex !== null && shouldDisplayNavbarMenu(hoverIndex) && (
              <div
                ...
                className="drop-shadow-xy4 absolute top-10 z-20 rounded-lg bg-white transition duration-300 ease-in-out"
              >
            ...
            <div className="flex shrink-0 cursor-pointer items-center justify-center">
              ...
              >
                ...
                <span className="text-imos-nav-text decoration-imos-deep-blue font-medium decoration-2 underline-offset-[3px] hover:underline">
