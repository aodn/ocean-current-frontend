...
const localRegions: LocalRegion[] = [
  ...
  { code: 'Brisbane2', title: 'Brisbane-Newcastle', coords: [151, 159, -33, -23] }, // don't change code as it's used to build url
  { code: 'Brisbane', title: 'Brisbane', coords: [152, 156, -29.5, -24.5] },
