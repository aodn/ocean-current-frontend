        ...
        <div className="mt-10 flex flex-col gap-y-8">
          ...
          >
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  pressure on their left, at a speed proportional to the pressure gradient. This is called the
                  geostrophic balance. Analogously, water flowing along the shelf is accompanied by coastal sea level
                  higher on the left. Satellite altimeters measure the sea level height in the open ocean. So combining
                  this information with tide gauges along the coast is, in principal, a means of estimating coastal
                  currents. We've just finished a study, using more than a thousand IMOS Acoustic Doppler Current
                  Profilers (ADCPs, deployed across 61 locations over 18 years) to see how well this works in practice.
                  The study used a new version
                  <a
                ...
                <p>
                  ...
                  <br />
                  <br />
                  Consequently, we now know how much confidence can be placed in the geostrophic estimates, the beauty
                  of which is that they span the entire Australian coast, for the last 30 years, at daily resolution.
                  This is useful if your application needs estimates of currents for a specific time, a time period, or
                  a region where there are insufficient direct observations, and you don't have access to a validated
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  &nbsp;&nbsp;1. The main core of the East Australian Current will not affect the first stage of the
                  ...
                  <br />
                  &nbsp;&nbsp;4. A warm-core eddy east of northern Tasmania may give yachts that keep well offshore a
                  bit of a boost. Last year, this eddy's estimated position changed quite significantly between 20 and
                  27 Dec.
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Run by Moninya Roughan's team at UNSW, FishSOOP serves up temperature profiles in near-real time,
                  fresh from the decks of fishing vessels operating in many regions around the country. FishSOOP
                  observations are mostly (but not exclusively) in waters less than about 200 m deep, so they complement
                  the Argo array perfectly.
                  <a
                  ...
                  cases, one of which addresses the crucial question&nbsp;'are our coastal waters measurably warmer?'.
                  The other ways of seeing if there are FishSOOP data in your region of interest is via some plots you
                  are already familiar with: look for magenta squares denoting FishSOOP locations in the various SST
                  plots and on the Argo index page. Click on the squares to see the temperature profiles.
                  <br />
                  <br />
                  ...
                  astonished to see large numbers of sharks and dolphins feasting on 'bait balls' in waters normally
                  full of surfers. Satellite imagery showed where cold water was coming to the surface at the coast (
                  <a
                    href="https://oceancurrent.aodn.org.au/product.php?product=snapshot&amp;region=Brisbane2&amp;date=20251207040000&amp;rtype=DR"
                    target="_blank"
                    rel="noreferrer"
                  ...
                  <br />
                  <br />
                  To finish, an apology: We haven&apos;t quite finished getting all the site navigation working the way
                  it soon will. But the holiday season is upon us, so we are announcing the site even though some pages
                  are still just using plain html.
                  <br />
                  <br />
                  <a
                    href="https://oceancurrent.aodn.org.au/fishsoop_php/fsa.php?region=NNSW&amp;date=20251207"
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  &nbsp;over our usual maps of sea surface height (SSH), we feel like we are adjusting our lenses to
                  have a clearer view of the ocean. Our traditional SSH maps, built by gridding along-track altimeter
                  data over a 10-day period and tide-gauge data near the coast, have&nbsp;allowed us to see large
                  mesoscale features (i.e., length scales larger than 100 km) like the eddies from the East Australian
                  Current and the Leeuwin Current.&nbsp;
                  <a
                  ...
                  <br />
                  <br />
                  We have added a new regional SSH 'SWOT experimental' product (Fig. 1) to the website to help us
                  explore the SWOT dataset further. These regional SSH maps combine wide-swath altimetry measurements
                  from SWOT with the existing IMOS-OceanCurrent Gridded Sea Level Anomaly (GSLA) dataset and with
                  in-situ measurements, like surface currents from ocean drifters, and full-depth
                ...
                <p>
                  ...
                  with the movement of drifters in the maps, and to compare the values with the velocity of ocean
                  currents measured by moored instruments and HF radars, all of which include the mean current, of
                  course. The blue arrows off Perth in Fig. 1 show a strong SE flow measured by the moored ADCPs. The
                  direction of the flow (averaged over the full depth and over a 25-h period to remove tidal effect)
                  agrees with the SSH measurements from SWOT.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  The 'SWOT experimental' maps are accessed by the button shown in the orange box in Fig 3. You can
                  choose between SSH (at least one daily map) and MDT (one map for 1993-2012) in the drop-down menu
                  shown in the red box (Fig 3). The 'info' button (purple box) has more information about the data shown
                  on the map.
                  <br />
                  <br />
                  We have selected specific regions for this product. Combined, the regions cover the whole Australian
                  coast, zoomed in enough for us to see the sub-10 km ocean features.&nbsp;The SWOT satellite revisits
                  the same region every 21 days, with an exception from March to July 2023, when the satellite revisited
                  a small number of regions daily. These 'SWOT experimental' maps are updated as soon as new SWOT
                  near-real-time data is available, but - as this data is still experimental - the latest maps can be
                  over a week behind.
                  <br />
                  <br />
                  Choosing one example to be highlighted in this news item was a challenge. We're still exploring the
                  SWOT dataset ourselves. So here's a list of our favourite SSH maps where SWOT measurements are the
                  main attraction:
                  <br />
                  <br />
                  <a
                  ...
                  <a
                    ...
                    rel="noreferrer"
                  >
                    SSH in-shelf gradient, with low SSH off Coffin Bay. Another example of SWOT showing in-shelf
                    features that were not resolved in the gridded SL
                  </a>
                  <br />
                  &nbsp;
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  &nbsp;
                  <br />
                  The mid-depth maxima in T and S measured within the eddy are similar to the ones we've described
                  before in&nbsp;
                  <a
                  ...
                  &nbsp;
                  <br />
                  Lense-type eddies are observed in maps of adj. SLA, but often don't have a SST signature. Fig 1
                  confirms that this eddy is indeed a lense: the eddy keeps a strong SLA signal and often a well defined
                  shape (
                  ...
                  ), with no clear signal in SST maps (Fig 1b). We see this eddy in the Adj. SLA maps because the eddy
                  is in geostrophic balance (i.e., surfaces with different water densities maintain the circular flow,
                  and vice-versa), and altimetry measurements capture the imprint of this flow in the free surface of
                  the ocean. Having said that, the eddy's rotation advects water meridionally, bringing cold waters to
                  the north, and hot waters to the south. In frontal regions, the T contrast between waters is seen as
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  <br />
                  These persistently low temperatures are unprecedented in the mooring observations on the Rottnest
                  Shelf (Fig. 1b). Previous records of subsurface cooling of less than 2°C below average occurred during
                  the summer peaks of the extreme&nbsp;<a href="https://ggweather.com/enso/oni.htm">2015-16 El Niño</a>
                  ...
                  ). The glider measurements from 27-29 January (Figure 3) show bottom waters cooler than 18oC
                  encroaching upon the shelf, but not reaching the surface, and high values of chlorophyll-<em>a</em>
                  &nbsp;concentration.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  The earlier 2015-2016 subsurface cooling seen in the mooring measurements was linked to a strong El
                  Niño event. Usually, in El Niño years, strong westerly winds at the equator induce low sea level
                  anomalies in the tropics that propagate to the WA coast, in the form of coastally trapped waves.
                  Because of the propagation of these waves, the El Niño Southern Oscillation has been linked to sea
                  level anomalies off Fremantle, WA (
                  <a href="https://agupubs.onlinelibrary.wiley.com/doi/full/10.1029/2002JC001763">Feng et al., 2003</a>
                  ). In El Niño years, the low sea level anomalies that arrive in WA are seen as an elevated thermocline
                  and negative sea surface temperature anomalies.&nbsp;
                  <br />
                  <br />
                  However, the&nbsp;
                  <a href="https://www.nature.com/articles/s41612-024-00890-0">2023-2024 El Niño was unusual</a>, with
                  no strong westerlies&nbsp;inducing the low sea level anomalies that propagate to the WA coast. So, at
                  the moment, we cannot see a direct link between this&nbsp;exceptional subsurface cooling
                  event&nbsp;and the 2023-2024 El Niño.&nbsp;
                  <br />
                  We know&nbsp;that regional air-sea interactions off WA&nbsp;
                  <a href="https://doi.org/10.1007/s00382-013-1961-z">can be significant at times</a>.&nbsp;Therefore,
                  the exceptional cooling in early 2024 could have been caused by a combination of regional ocean
                  dynamics. This is still under investigation.
                  <br />
                  &nbsp;
                </p>
              </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  coast. As it moved, it drew heat and moisture from the upper ocean, leaving an imprint in the surface
                  of the ocean and in the waters below.&nbsp;&nbsp;
                  <br />
                  We were curious to see how TC Alfred's imprint in the ocean shows up in the figures of the website.
                  Our figures show changes in sea level, surface waves, sea surface temperature, and temperature and
                  salinity in the top 50 meters of the ocean.
                  <br />
                  &nbsp;
                  <br />
                  <strong>Sea level</strong>
                  <br />
                  The easiest way to spot TC Alfred in our maps is by looking at the adjusted sea level anomaly (SLA)
                  map off northeast Australia (Fig 1), which includes atmospheric isobars. In Figure 1, the colours show
                  adjusted SLA values, and the cyan lines are the atmospheric pressure at sea level, spaced at 2 hPa.
                  ...
                  comparing the maps of&nbsp;adjusted SLA&nbsp;(~ 0 m; Figure 2) and&nbsp;non-tidal SLA&nbsp;(~0.5 m).
                  The values are different because the adjusted SLA has the effect of atmospheric pressure over the
                  ocean removed, while the non-tidal SLA doesn't. The non-tidal SLA below TC Alfred is high because
                  Alfred has low atmospheric pressure in its centre compared to the surrounding environment. This
                  localised low atmospheric pressure allows the ocean to rise below it.
                  <br />
                  <br />
                  <img
                    alt=""
                  ...
                  &nbsp;
                  <br />
                  Note that, on the 2 March, there is a dark blue patch at the southeast corner of the figure,
                  indicating values below the colourbar threshold. These values are non-realistic and are likely caused
                  by difficulties on processing the data near heavy cloud coverage associated with TC Alfred.
                  <br />
                  <br />
                  ...
                  &nbsp;
                  <br />
                  Figure 4 shows temperature (top) and salinity (bottom) values measured by both floats. The first
                  column shows values plotted against depth (in meters) – showing that the waters at the top 50 meters
                  were warmer and saltier before TC Alfred passed.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  ...
                  vertical movement of the ocean that happened between the days, leaving only the changes caused by
                  mixing and heat exchange.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  The third column shows the difference between the temperature and salinity profiles in potential
                  density space – confirming that there was a 0.7°C drop and a 0.1 psu drop in the upper part of the
                  water column after the cyclone has passed.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  The freshening seen in the Argo data is a result of heavy rainfall associated with the cyclone,
                  'diluting' the salty waters of the Coral Sea. The cooling is linked to the cyclone drawing heat from
                  the upper ocean, and strong winds mixing the upper layer.
                  <br />
                  <br />
                  <img
                    alt=""
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  . An intense Leeuwin Current, acompannied by&nbsp;strong winds from&nbsp;tropical cyclone Sean,
                  carried that hot water southward along the WA shelf break&nbsp;(Figure 3b, c).
                  <br />
                  <br />
                  ...
                  effects in kelp, seagrass, and coral reef ecosystems. However, it has already impacted local marine
                  life due to thermal stress, including 30,000 dead fish washing ashore&nbsp;
                  ...
                  &nbsp;
                  <br />
                  The SST in some regions off WA were exceeding the range we had set in our maps. We have now changed
                  the range of the colourbar in&nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  currents off NSW. This is because the East Australian Current is about 250km&nbsp;off Sydney, skirting
                  around a cold-core (cyclonic, low sea level, clockwise rotation) eddy while the opposite is happening
                  off Tasmania.&nbsp;Here, a strong warm-core eddy is situated just off the continental slope
                  potentially giving yachts a boost of a knot or more.
                </p>
                <p>
                  Instead of illustrating the EAC using an image of sea surface temperature, this year we have chosen to
                  use a satellite image of chlorophyll concentration, inferred from the colour of the water. Mariners
                  know that the colour of the ocean is very variable, with chlorophyll-laden coastal waters sometimes
                  being described as 'dirty', in contrast to the warmer, clearer waters brought south by the&nbsp;EAC.
                  The image shows that the strongest velocities are to be found at the boundary between the tropical
                  (shown as dark blue) and temperate (shades of green) waters. But since those velocities are well clear
                  of the rhumb line this year, skippers will not be too concerned about currents for the NSW leg of the
                  race, except perhaps near Eden. &nbsp;
                </p>
                <p>
                  <img
                    alt=""
                ...
                <ol>
                  ...
                  <li>
                    ...
                    latest-available SWOT data overlain on SST imagery for the time, showing weak currents near Sydney
                    on 12 Dec.
                    <img
                      alt=""
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  visualise and examine time series of wave characteristics collected by the Australian wave buoys from
                  01 Jun 2024 - it's as simple as clicking a wave buoy symbol on the Surface wave map.
                  <br />
                  &nbsp;
                  <br />
                  ...
                  heights of 8+ m, while a Sentinel-1 Synthetic Aperture Radar (SAR) satellite pass (black dots
                  straddling the altimeter track) revealed dominant wave period of more than 12 s.
                  <br />
                  <br />
                  <img
                    alt=""
                  ...
                  &nbsp;may be responsible for generating such extreme rogue wave as observed at Cape Sorrell. While it
                  is not always straightforward to pinpoint the exact mechanism, it is well known that during extreme
                  storm conditions, increased nonlinearity can lead to the formation of such giant waves. Under certain
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  moderately high (15-20cm) at Tweed and Brunswick Heads, near zero at Yamba and Coffs, high again at
                  Port Macquarie, Crowdy Head and Forster, then even higher (about 25cm) at Sydney. The SWOT data for
                  this day shows, <strong>for the first time</strong>, the details of how sea level changes across the
                  continental shelf. The across-shelf gradient of sea level is closely related to the magnitude of the
                  alongshore current (via geostrophy). The strong gradient off Yamba (see the sharp change from green to
                  yellow) indicates that a strong, narrow, southward flow existed at mid-shelf on this day, while no
                  such flow (this strong) existed over the continental shelf off either Coffs or Brunswick Heads, the
                  two closest gauges.
                  <img
                    alt=""
                ...
                <p>
                  ...
                  gauge data (black lines) at several sites for a period, overlain with the small number of SWOT
                  estimates (which are only made at intervals of 21 days for each track; red circles). This plot also
                  lists 4 numbers for each gauge: 1) the mean sea level for the study period, relative to the long-term
                  mean, 2) the mean difference of the tide gauge from SWOT (the bias), 3) the mean absolute anomaly
                  (MAA) of the tide gauge data, and 4) the mean absolute error (MAE) of the de-biased tide gauge
                  relative to SWOT. The MAEs are fairly consistent across the east coast gauges, ranging from 3 to 5cm
                  but less so across the south coast where they range from 4 to 12cm. Importantly, MAEs are almost
                  always significantly smaller than the MAAs, which says that SWOT estimates of coastal sea level have
                  usable skill. Apart from the fact that SWOT data is never colocated with the tide gauges, some of the
                  'error' measured here is due to the differences between how the two data sets are de-tided and
                  adjusted for atmospheric effects. The biases of the tide gauges relative to SWOT are particularly
                  interesting to us, ranging from -5 to 4cm on the east coast and -4 to 11cm on the south and west
                  coasts. These biases, once confirmed, will replace the estimates we have been using when we include
                  tide gauge date along with traditional altimeters in our gridded sea level anomaly product without
                  erroneous estimates of the mean across-shelf sea level gradient causing erroneous estimates of mean
                ...
                <p>
                  ...
                  1.5m/s) southward along the mid- to outer continental shelf, while cooler (24C) water within about 10
                  to 15km of the coast remained essentially motionless, according to de-tided alongshore velocity
                  observations by four Acoustic Doppler Current Profilers off Sydney (two tiny red arrows in the cool
                  water, two big ones in the warm water) as well as the geostrophic velocity estimates from SWOT. This
                  is a more striking example of SWOT working well over the continental shelf than we found back in
                  March.
                </p>
                <p>
                  ...
                  moorings, we see the Mean Absolute Error of the non-tidal alongshore flow varying from 15cm/s (half
                  the mean non-tidal speed) at SYD100 to 52cm/s (twice the mean speed) at BMP070 in southern NSW, with
                  the MAE over 9 sites being 23cm/s. These results are obtained using a spatial-averaging stencil that
                  is 0.1 x 0.1 degrees across. A smaller stencil gives larger errors while a larger stencil (0.18 x
                  0.18) gives smaller errors (18cm/s instead of 23cm/s), but fewer estimates. Neither aggregate MAE is
                  particularly small compared to the aggregate mean speed (38cm/s) so let's look into the circumstances
                  of some of the big errors.
                </p>
                <p>
                  Firstly, the BMP070 mooring is close to and inshore of Montague Island, probably explaining the poor
                  result there. The results at ORS065 are also poor, with the MAE being equal to the mean speed at
                  23cm/s. This location is also very close to land, so the number of SWOT 2km x 2km postings within the
                ...
                <p>
                  ...
                  velocity across 6 sites within the Great Barrier Reef off NE Australia does exceed the 11cm/s mean
                  non-tidal speed.
                </p>
                <p>
                ...
                <p>
                  ...
                  useful at most locations, aside from the issue of it being only infrequently sampled. SWOT's
                  geostrophic velocity estimates also have useful skill in places, principally off NSW where the
                  non-tidal sea level and velocity variability are very high, but also at at least one location in the
                  lagoon of the Great Barrier Reef (in the Capricorn Channel away from islands), even though the tides
                  are strong and non-tidal flows are weak there.
                </p>
                <p>
                ...
                <ul>
                  <li>
                    ...
                    barometer response to atmospheric pressure has been removed. To compute anomaly, we have debiased
                    the tide gauge estimates of the ASLA using a two-step process. The first is the usual one of
                    subtracting the long-term mean of ASL from the data from each gauge. For the 2nd, we evaluate the
                    difference (gauge minus SWOT) from SWOT for every overpass then take the mean over all overpasses.
                    These biases are the first of the two numbers given below the name of each tide gauge. The second
                    number is the remaining difference for the present overpass with this bias removed.
                  </li>
                  <li>
                    Fig 2. Time-series of SWOT (red dots) and tide gauge (black lines) estimates of de-tided,
                    IB-adjusted sea level on the a) west and south and b) east coast of Australia. In the description of
                    the statistics listed, &lt; &gt; is the time-mean operator, while || is absolute value.
                  </li>
                  <li>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  ). He called for help using his smart watch when it became clear to him that this was no ordinary rip
                  he was caught in. Satellite imagery for Saturday shows that cold water was near the coast (as happens
                  in winter if&nbsp;the warming influence of the East Australian Current is absent - see how cold Morton
                  Bay gets in winter!), while images for Sunday show that that cold water had been&nbsp;drawn offshore
                  to the south east as a 30km-long plume (Figure 1, made using
                  ...
                  entrained in a larger-scale&nbsp;seaward flow. But why did that flow exist? We think it
                  was&nbsp;because there was an extremely strong clockwise-rotating, cold core eddy&nbsp;just offshore
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  near the centre of a high pressure system. Now that the event has passed, and the data are in, let's
                  see what did (and didn't) happen, noting that atmospheric pressure is just one of many things
                  ...
                  total sea level, that is, the sum of several signals with different characteristic time scales. The
                  tide is the dominant signal, with beating constituents at 12 and 12.5 h period. At that location, the
                  low tide of 4 July 2024 was indeed very low - about 0.9 m below mean sea level (MSL - the zero of the
                  ...
                  . These are wind- and pressure-driven events associated with the rapid passage of localised low
                  pressure systems. Then around 1 July we see the sudden drop of sea level into a sustained period of
                  values between 0.1&nbsp;and 0.2m below MSL. This is the ocean's ('inverse barometer') response to the
                  large high atmospheric pressure system. One of the reasons it does not go as far as 0.3m below MSL
                  (which is the effect of pressure alone) is that sea level is gradually
                  ...
                  of the system but you also see isolated regions of either very low or very high sea level,
                  particularly off the coast of NSW. Those are ocean eddies unrelated to the weather. You also see that
                  both south-west WA and much of Qld have high sea level near the coast. These are both due to the wind
                  blowing anti-clockwise around the huge high pressure system, from the north off SW WA, and from the SE
                  off Qld (in both cases raising sea level on the left of the wind thanks to the Coriolis effect).&nbsp;
                  <br />
                  <br />
                  ...
                  show this period of low sea level? A: Because the response to pressure forcing is not actually
                  included in that forecast. Why not? see the info button at the top of our
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  &nbsp;
                  <br />
                  The way we look at the ocean from space was impacted by the geomagnetic storms that caused the
                  auroras. The height of the sea surface is measured globally by radar altimeters onboard satellites.
                  These altimeters send microwave pulses that travel from space, reflect on the surface of the ocean,
                  and return to the altimeters. The height of the sea surface is then calculated considering the time it
                  took for the pulses to travel from the altimeter and back. The higher the surface of the ocean is
                  (e.g., due to ocean dynamics), the shorter the path the pulses travel, and therefore, the quicker it
                  ...
                  interacts with whatever is on its way, including water vapour and ions and electrons in the upper
                  layers of the atmosphere (aka: the ionosphere). Because these particles impact the signal travel time,
                  several corrections are applied to the data. One of the corrections considers the density of ions and
                  electrons in the ionosphere as predicted by models. However, the high solar activity that reached
                  Earth in mid-May led to sudden and abrupt changes in the ionosphere, making it difficult to apply the
                  ionospheric corrections to the data.
                  <br />
                  &nbsp;
                  <br />
                  ...
                  geopositioning systems, but also abruptly alters forces that impact satellite tracking (like solar
                  winds and drag), meddling with their characterisation and prediction.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  ...
                  So, sudden changes in the ionosphere, difficulties in determining the orbit of the satellites
                  precisely, and noisier measurements, degraded the sea surface height measurements between the 11 and
                  the 13 May.&nbsp;
                  <br />
                  &nbsp;
                  <br />
                  The result of this degradation is seen in the along-track data for the lower-orbit altimeters – see in
                  Figure 1 the higher heights in some of the tracks at 30-60ºS, compared to data from other nearby
                  tracks. This along-track data, within a 10-day asymmetric window, is interpolated, together with
                  coastal tide-gauge measurements, to build our&nbsp;
              ...
              <div className="rounded-b bg-white p-4">
                <div>
                  <p>
                    ...
                    than expected! SWOT is a new type of satellite altimeter. Instead of just measuring sea level
                    directly below the satellite along a narrow track, it measures sea level out to the side as well.
                    Not nearly as far as a scanning radiometer does (e.g. to measure sea surface temperature) but wide
                ...
                <div>
                  <p>
                    ...
                    such as the three shown) the flow field to be, not just at large scales, but at small scales as
                    well.
                  </p>
                </div>
                <div>
                  <p>
                    ...
                    altimetry data. So stay tuned for more information. In the meantime, we congratulate the SWOT
                    mission scientists and engineers at NASA, CNES and other agencies who designed, built and operate
                    SWOT. And incidentally, SWOT is not just for oceanography. In hydrology mode, it measures lake and
                    river levels - globally!
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  We have exceptional ocean conditions for this year's race, as far as favourable currents are
                  concerned, thanks to the combined effect of four warm-core (anti-clockwise rotating) eddies and one
                  cold-core (clockwise) eddy. Indeed, of the past 30 years, this appears to be the one when ocean
                  currents most need to be taken into account by competitors (in addition to wind and waves) when
                  choosing a course.&nbsp;
                  <img
                    alt=""
                ...
                <p>
                  ...
                  as far south as Jervis Bay. The second warm eddy is off southern NSW and will also potentially provide
                  a boost, all the way to the border.
                </p>
                <p>
                  East of Bass Strait is where a difficult decision has to be made. Yachts steering straight for Hobart
                  will probably encounter weak adverse current because of the cold core eddy, while yachts running
                  closer to due south (near 151E) may encounter strong favourable currents (possibly 2kt or more,
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  events along the Bonney coast.
                </p>
                <p>
                  The Bonney upwellings are well-known events, with cold, nutrient-rich bottom waters rising to the
                  surface, providing a favourable habitat for phytoplankton to grow. We've described the Bonney
                  upwelling at IMOS-OceanCurrent before, e.g. when it had a late start in 2020, and when it was observed
                  by an ocean glider in 2016.
                </p>
                <p>
                ...
                <p>
                  ...
                  ENSO and the positive SAM conditions currently in place will enhance the intensity of the events yet
                  to come. In addition, the persistence and strength of events might precondition following events,
                  leading to stronger temperature anomalies.
                </p>
                <p>
                  <img
                    alt=""
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  <br />
                  Explore the EAC by clicking on the 'EAC Mooring Array' button in the menu on the right, in the
                  website's
                  <a href="https://oceancurrent.aodn.org.au/index.php">frontpage</a>. The '
                  <a href="https://oceancurrent.aodn.org.au/eac_about.php">About the EAC mooring array dataset</a>'
                  button (Fig. 1A) provides information and references about the mooring and the dataset. The
                  information icon at the top menu (Fig. 1E) explains the datasets and what is shown on the graphics.
                  You can explore the data in several ways; click on the calendar icon to look at a specific date (Fig.
                  1B), click on the movie icon for a movie of daily images surrounding a particular date (Fig. 1D), or
                  click the table icon to select a particular period that you are interested in (Fig. 1C).
                  <br />
                  <br />
                  <img
                    alt=""
                  ...
                  5th mooring from the left (large black dot, Fig 2a). The total transport, integrated in depth across
                  the whole array, was of 18 Sv (Figure 2a, b).&nbsp;In Figure 2, on the&nbsp;plots on&nbsp;the right,
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  leading into a large bay, slack tide in the strait occurs close to the times of high and low tide
                  ...
                  way to estimate slack tide more precisely at any&nbsp;location, but in the mean time, have added inset
                  plots to each of our maps, showing the tidal velocity (resolved along the stated direction) for a few
                  tidal cycles at a single selected point along with height at that point and at a nearby reference
                  point. As you step through the maps, 'slack at x' will appear, specifying the exact time of slack tide
                  at the point marked with a magenta x. The key to understanding the physics behind slack tides&nbsp;is
                  to know that the tide is a mix of waves propagating in various directions, at different amplitudes.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  there will be a special IMOS session, and an East Australian Current session, how could we pack our
                  bags without checking the state of the EAC? But disappointingly, from a morning dip perspective, the
                  news is not good: the water is presently 19.5°C, about 2º&nbsp;less than climatology, sitting
                  somewhere in the
                  <a
                  ...
                  , i.e. it is only this much colder than usual less than 10% of the time. The culprit is surely the
                  cold core eddy, around which the EAC has been diverting for
                  <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  the many riddles of Australian oceanography: what's the biggest difference between chlorophyll-a
                  imagery of west coast and east coast eddies?
                </p>
                <p>
                ...
                <p>
                  ...
                  (anticlockwise, warm-core, depressed thermocline), while east coast eddies are more likely to have
                  high near-surface chl-a in cyclonic (clockwise, cold-core, raised thermocline) eddies.
                </p>
                <p>
                  The west coast image for 19 April shows three anticyclonic eddies with elevated chl-a. But unusually,
                  two of these are very close to each other, so there is strong horizontal shear of the north-south
                  flows in the gap between them.
                </p>
                <p>
                  The east coast image shows the usual relationship of rotation and chl-a, but again, the placement of
                  the eddies is unusual (coincidence, I assume): the two eddies are nearly symmetric, with the cyclonic
                  one north of the anti-cyclonic eddy, so there is a strong landward flow in the gap between them,
                  bifurcating directly off Brisbane. I don't recall ever seeing this before (so good thing the outage
                  was not irrecoverable).
                  <br />
                  <img
                    alt=""
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  This summer, however, major deviations of the flow of the EAC have also been <em>clockwise</em> around
                  a relatively large
                  <em>cold</em>-core eddy. An eastward deviation of the EAC is presently happening at about 30S, with
                  the flow reconnecting with the continental shelf at 32S. In early March this eddy was off Byron Bay,
                  where an
                  <a
                  ...
                  estimates of near-surface chlorophyll-a show elevated levels in the eddy.&nbsp;The eddy appears to
                  have originated north of Brisbane in early January, when it appeared that, unusually, very little of
                  the warm EAC water was going south. The southward flow resumed later in January and by 9 February the
                  flow was unusually continuous from 29S all the way to the Victorian border. Indeed, a
                  satellite-tracked drifter went along the continental slope in EAC waters from 30S to 38S in just 9
                  days (9-18 Feb, 1.1m/s on average).
                </p>
                <p>
                  What were the impacts of the EAC's odd behaviour? And why did this happen? Maybe we'll hear thoughts
          ...
          <div
            className={cn(
              'flex flex-col gap-y-8',
              selectedFilter !== null && selectedFilter !== '2020-2023' && 'hidden',
            )}
          >
            <article className="p-2">
              <div className="flex items-center justify-between rounded bg-[#F1F6F9] p-4">
                <div>
                  <h3 id="The_plume_and_the_bloom_ocean_colour_off_South_Australia_rsquo_s_coast">
                    <a
                      href="#The_plume_and_the_bloom_ocean_colour_off_South_Australia_rsquo_s_coast"
                      className="anchor"
                    >
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Australia – the Murray River plume, and a stirred-up phytoplankton bloom. The Murray's plume is seen
                  ...
                  absorb and reflect light in the visible spectrum, we can see the coastal impact of the Murray's
                  flooding from space. The plume's signature is seen as values higher than 3 mg/m3&nbsp;in our
                  Chlorophyll-a Snapshot maps from
                  ...
                  &nbsp;
                  <br />
                  In contrast, the phytoplankton bloom is a shorter-lived feature, lasting only a few weeks. This bloom
                  is likely linked to the
                  ...
                  sunlight. Multispectral sensors onboard orbital satellites, such as the Sentinel-3 constellation,
                  allow us to measure
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  navigators might like to factor ocean currents into their race strategy, and that's the far south of
                  NSW, between about 36.5S and 37.5S.
                </p>
                <p>
                  Seaward of the 200m isobath, yachts may find a knot or two of favourable current, thanks to a
                  warm-core (anticlockwise) eddy centered close to 151E. The surface temperature of this eddy is not
                  particularly high but its existence over the last month is not in doubt. Apart from glimpses between
                  clouds of SST and several altimeter overpasses, the eddy was also observed by a satellite tracked
                  drifter, which got caught in the strong northward flow on the eastern flanks of the eddy, between it
                  and a cold core eddy farther east.
                </p>
                <p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  &nbsp;
                  <br />
                  SWOT is the first satellite altimeter capable of measuring the height of the sea (and lakes and
                  rivers) in two dimensions at once. The sensor onboard SWOT measures the sea surface height along a 120
                  km swath (see an animation&nbsp;
                  ...
                  ocean sea level as well as sea surface temperature. These smaller features play an important role in
                  the transport of heat, carbon, and nutrients between the ocean's surface and deeper layers.
                  <br />
                  <img
                    alt=""
                  ...
                  />
                  <br />
                  SWOT will be in a fast-sampling 1-day orbit for one year (Figure 1), covering the Earth's surface
                  daily, before moving to a 21-day orbit for 3 years. During this fast-sampling orbit, several
                  oceanographic campaigns will collect&nbsp;<em>in situ</em>&nbsp;data at key locations of the ocean.
                  This data will help us to validate SWOT's measurements. The Australian scientific community (
                  <a href="https://auswot.org">AUSWOT</a>) has planned several activities aligned with SWOT objectives,
                  including deploying new mooring arrays and conducting scientific voyages. The voyages, planned for
                  2023, will take high resolution measurements of the East Australian Current and of a section of the
              ...
              <div className="rounded-b bg-white p-4">
                <div>
                  <p>
                    ...
                    call it MyOceanCurrent, because you're in control. Access is via the green button on our landing
                    page. Click Help if you need it. If you create a (free) MyOceanCurrent account you will get access
                    to more viewing tools, and your settings will be remembered. Our example image zooming in near
                    Fraser Island where a cyclonic eddy is interacting with the East Australian current shows some
                    striking 'woodgrain' features in the warm waters aligned with the flow.
                  </p>
                </div>
              </div>
            </article>
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  <div className="col-md-8">
                    <p>
                      As we head into a third La Niña summer, more eyes than usual are focussed on the ocean. This is
                      for a host of reasons (coral bleaching and coastal inundation, to name just two) in addition to
                    ...
                    <p>
                      Sea level in the region of the South Pacific Convergence Zone (SPCZ) is currently particularly
                      high. The centile ranking of the detrended (i.e with about 6cm subtracted) sea level anomaly (Fig.
                      2) is above 95 for a large region between 20S and 10S, indicating that the temperature anomaly
                      extends hundreds of metres beneath the surface.&nbsp;In particular, the positive anomaly this
                      September was greater than it was&nbsp;
                      <a
                    ...
                    <p>
                      ...
                      no signs of diminishing, leading to projections of higher-than average rainfall this summer for
                      much of Australia. Please note: our references to last year's conditions do <strong>not</strong>{' '}
                      imply that there will definitely be more rain than last summer or autumn, or that the present
                      rains will continue. Please stay tuned to the BoM's forecasts.
                    </p>

                    <p>
                      These monthly maps are reached via the "Maps" dropdown menu on our home page (not via the
                      carousel).
                    </p>
                  </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  unique ecosystem, and one of the most valuable fisheries in Antarctic waters – the Patagonian
                  Toothfish. There, the ocean circulation is dominated by the strong, eastward flowing Antarctic
                  Circumpolar Current. Due to this strong flow, autonomous profilers are often quickly flushed away from
                  the region, making it difficult to profile ocean properties surrounding the plateau. Argo floats with
                  altered missions are able to remain in the region for a longer time – such as the floats 5906651 and
                  5905510, deployed in the plateau in the past months. By parking at the ocean's floor, instead of at
                  1000 m depths, the floats were less susceptible to the strong surface flow.
                  <br />
                  <br />
                  ...
                  time. You can see their movements in this
                  ...
                  &nbsp;like to hang to the north of the Kerguelen Island.&nbsp;For as long as the CTDs are stuck in
                  their fur, the seals profile temperature and salinity data at the top 800 m of&nbsp;the ocean, every
                  time they dive – and the data is transmitted every 6 hours.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  You can now quickly access the daily maps of seals and Argo locations and the timeseries of sealCTD
                  data via the carousel in our frontpage.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <div>
                  <p>
                    ...
                    (relative to the SSTAARS climatology), averaged over each of the smaller map regions, are presented
                    as a bar plot of monthly means since 1993. The time series provide a way of putting events in the
                    context of the last three decades. As has been widely reported (but usually for averages over much
                    larger regions), almost all of the time series of temperature anomalies indicate a clear warming
                    trend, including over the Great Barrier Reef.
                    <span> </span>
                  </p>

                  <p>
                    This summer's monthly mean temperatures for the northern, central and southern GBR (Fig. 1) indicate
                    the reef experienced anomalous heating at the very beginning of summer with the highest-ever
                    December temperatures in each of the time series. There was an intense burst of heat in early
                    January, particularly in the central region, but heavy cloud in the later part of January and for
                    much of February kept the monthly anomalies relatively low. In early March, however, temperatures
                    rapidly increased to 2°C anomalies by the second week, over much of the Great Barrier Reef,
                    particularly in the central region (Fig. 2) and a high monthly mean anomaly. Sadly, not long after
                    that, observations of bleaching were reported on the outer reef.
                    <br />
                    &nbsp;
                  </p>
                </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  network, several satellite platforms (radar altimeter and Synthetic Aperture Radar (SAR) missions),
                  and the near real-time modelled wave field from the Australian Bureau of Meteorology's (BoM) AUSWAVE-R
                  ...
                  storms and severe weather, were well captured in the new IMOS-OceanCurrent surface waves product
                  (Figure 1). The BOM-NSW issued a severe weather warning on 9th&nbsp;Mar 2022 for damaging surf on the
                  central and southern parts of the NSW coast (Figure 2), following the high waves generated from a
                  low-pressure system/east coast low in the Tasman Sea.&nbsp;Significant wave heights of 5-6 m were
                  recorded by wave buoys at Eden and Port Kembla (
                  <a href="http://oceancurrent.imos.org.au/waves/waves3.php?date=20220308200000">Figure 1a</a>, purple
                  arrows). Offshore, the low-pressure system generated even higher wave - heights up to 7 m - as
                  observed by satellite altimeter passes and predicted by BoM's AUSWAVE-R model (
                  <a href="http://oceancurrent.imos.org.au/waves/waves3.php?date=20220309100000">Figure 1b</a>). Note
                  that buoy measurements nearest in time and all available satellite passes within +/- 3 hours of the
                  background AUSWAVE-R wave field are displayed. The 6-hour window allows sufficient buoy measurements
                  and satellite passes to be available for spatial display with the caveat that some loss of agreement
                  of wave information between various data sources can be expected. The maps also include the mean wave
                  periods and peak wave direction of the longer swell waves from Sentinel-1 SAR passes (black, white,
                  and grey circles). However, none of these passes coincided over the region of interest to be useful in
                  this event.
                  <br />
                  <br />
                  The IMOS-OceanCurrent wave product has been made possible thanks to provision of wave data from
                  several sources including State and Commonwealth Government wave buoy custodians, sourced through
                  IMOS-AODN National wave buoy data archive, satellite altimeter wave height data from RADS, Sentinel-1
                  near real time SAR wave data from IMOS-AODN, and BoM's AUSWAVE-R background wave field. The latency of
                  all these datasets is variable, but usually less than 24 hours.&nbsp;For a forecast of surface wave
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  <br />
                  As soon as competitors leave Sydney Harbour, they might get a small boost from southward currents on
                  the western flank of a large anticyclonic (warm) eddy sitting off Sydney. Extending from Jervis Bay to
                  Horseshoe Bay, however, sailors could be impacted by a northward current. This current is associated
                  with an offshore cyclonic (cold core) eddy, that has been moving towards the coast since
                  mid-September. This northward current is now weaker than 1 knot, but it may strengthen if the eddy
                  continues to move towards the coast. Competitors might escape some of this adverse flow if they stay
                  close to shore.
                  <br />
                  &nbsp;
                  <br />
                  This cyclonic eddy has a negative sea surface height anomaly of 0.5 m, centred offshore of Batemans
                  Bay, and it's the most intense cyclonic eddy we've seen in the region this year. In fact, over the
                  last 28 years, only 3% of the height anomalies in this region were lower than the current conditions.
                  This extremely low height anomaly is seen as a large dark blue patch at the eddy location in our
                  ...
                  Snapshot SST products. You can also find more information on how science can inform sailors decisions
                  at CSIROscope (<a href="https://blog.csiro.au/sydney-hobart-ocean-science/">here</a>). May all
                  competitors be safe and have an exciting race!
                  <br />
                  <br />
                  &nbsp; &nbsp;
                  <a href="http://oceancurrent.imos.org.au/product.php?product=daily.SST_ANOM&amp;region=Syd-Hob&amp;date=20211215014745&amp;rtype=DR">
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  same with the adjusted sea level anomaly (ASLA). A reminder of our intention to do this&nbsp;came on
                  12 October 2021 when we noticed that the ASLA over the shelf in the Great Australian Bight was very
                  high (because of the strong south-westerly winds associated with a deep low centred that day near 42S
                  130E). By selecting 'Centiles' from the dropdown menu for Australian-region maps of ASLA, you can now
                  see that the coastal sea level that day was indeed comparable with the highest few percent of all
                  co-located anomalies in our archive of daily maps.
                </p>
                <p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Many people know that the sea level goes up when the atmospheric pressure goes down. This is called
                  the inverted (or sometimes inverse) barometer effect, or IB for short. But did you know that our maps
                  of 'sea level' (and/or its anomaly) did <strong>not</strong> include the effect of pressure? Realising
                  that this may disappoint or surprise some users, we have decided to make two changes to our website:
                </p>
                <p>&nbsp;</p>
                <ol>
                  <li>
                  ...
                  <li>
                    ...
                    <strong>not</strong> include the effect of pressure, we are reinstating the traditional term
                    'adjusted sea level anomaly' for sea level observations that have had the effect of pressure
                    removed. The 'info' button explains why this is the quantity of greater interest to oceanographers,
                    if not to residents of the coast.
                  </li>
                </ol>
                <p>
                  How important is the pressure effect? It is approximately 1cm per hPa. That is not much most of the
                  time but in the centre of a 960hPa low pressure system it amounts to a rise of 50cm. Several deep lows
                  passed south of Tasmania in July 2021, resulting, on 25 July, in the highest non-tidal sea level seen
                  for many years. At right you see our new 'non-tidal sea level' map for that day.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  <span className="normaltextrun">
                    ...
                    <span>
                      &nbsp;vessel, owned and operated by NIWA (National Institute of Water and Atmospheric Research).
                      The primary purpose&nbsp;
                    </span>
                    <span>of</span>
              ...
              <div className="rounded-b bg-white p-4">
                <div>
                  <p>
                    ...
                    over-washed by warm EAC water, and in contrast, smaller frontal eddies being generated and advected
                    by the EAC. While the scale and the nature of the processes differ, the interaction of the warm EAC
                    and swirling denser shelf-water always creates interesting interactions which impact local
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Pacific have been added to&nbsp;our 6-day Sea Surface Temperature (SST)&nbsp;maps. The new regions
                  are:
                </p>
                <img
                ...
                <p>
                  All regions can be accessed from&nbsp;IMOS Ocean Current via the direct links provided above or via
                  the SST map selection from the main page.
                </p>
                <p>
                ...
                <p>
                  These changes&nbsp;provide&nbsp;easy&nbsp;access to&nbsp;OceanCurrent&nbsp;information,
                  and&nbsp;improve the experience or our users when visiting the website. As always, we value users'
                  feedback. If you have comments or suggestions, please&nbsp;contact&nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  While TC Seroja and TC Odette were off the coast of WA, two cyclones of a very different kind have
                  come together off Newcastle. These are oceanic cyclones - clockwise rotating bodies of water with low
                  ...
                  about 250km south, and the cold core eddy was interacting with the East Australian current - much of
                  the flow going around it instead of continuing along the continental slope to Sydney and beyond. Both
                  types of eddies have been seen before to behave like this individually. But can anyone recall an
                  instance of two such eddies colliding? I can't, but this is what seems to have happened.&nbsp;The next
                  3&nbsp;weeks were&nbsp;extraordinary. By 13 April (image 3) we see an elongated body of cold water had
                  ...
                  floodwaters in the inner shelf - but that's another story). An Argo float also made some observations,
                  a few times&nbsp;
                  <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Tropical Cyclone Niran circled in a small region off Cairns for 4-5 days as it developed from a
                  tropical storm to a Category 2 tropical cyclone before intensifying as it sped southeast. When a
                  cyclone remains in one place for a while the intense winds which drive Ekman pumping, wind-forced
                  currents and vertical mixing reinforce and can generate a cold core eddy. Like most cold-core eddies
                  the surface signature is a depression in the sea level and cool surface temperatures. Although the sea
                  level anomaly at the surface is quite small the sub-surface signal can be significant with deep
                  vertical mixing, elevation of the thermocline of the order of 100m and strong currents at depth.
                  <br />
                  The cold core eddy created by TC Niran is evident, now that the cloud has cleared, in the satellite
                  SST about 150km east of Lizard Island,
                  <strong>Figure 1</strong>. Sea level anomalies, SLA (white contours), indicate a 30cm depression which
                  appears to be off-centre from the SST anomaly. Some of this misalignment may be due to the 4-day lag
                  in the gridded sea level anomaly (GSLA) in near-real time because it requires a time window of +/-5
                  days. However, unlike cold core eddies in the East Australia Current, the two anomalies (SST and SLA)
                  will not necessarily align because the processes which form them, vertical mixing and the Ekman
                  pumping, do not usually have the same spatial structure under a tropical cyclone.
                  <br />
                  &nbsp;
                  <br />
                  ...
                  crossed the Pacific from New Caledonia to the Great Barrier Reef in about 5 months. It began with a
                  very strong surface expression of 60cm but after 3 months it had eroded to less than 40cm and by the
                  time it had negotiated the shoaling passage south of the Coral Sea Islands and reached the shelf break
                  its surface expression had reduced to 20cm. The TC Niran eddy is much closer to the Great Barrier Reef
                  so will experience much less dissipation before it arrives at the outer shelf. How the eddy will
                  interact with the shelf is not known and probably dependant on the prevailing winds and current but it
                  certainly has the potential to raise the thermocline at the shelf break for an extended period. The
                  eddy is headed straight towards the Lizard Slope mooring in 350m so this is an opportunity to observe
                  the interaction through the temperature and velocity profiles. It even has the potential to impact
                  coral studies at the nearby Lizard Island Research Station.
                  <br />
                  &nbsp;
                  <br />
                  ...
                  <strong>Figure 1</strong>) of the Niran eddy to reach the outer shelf and 25 days for the centre of
                  the surface depression (at 148°E) to arrive. Of course, these estimates cannot factor in how this
                  complex eddy structure will evolve as it propagates westward which could affect the timing. It is also
                  unknown whether the deep ridge (~1200m) which lies just west of the eddy will slow or redirect it, so
                  too, the slope current as the eddy approaches the slope.
                  <br />
                  &nbsp;
                  <br />
                  &nbsp;
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  <div className="col-md-9">
                    <p>
                      For centuries, drifting bottles have been used to map ocean currents, building our understanding
                      of how objects and organisms travel with the flow. In modern times, these drifters are floating
                      buoys, with sensors and built-in satellite trackers to trace their path. Despite their low-tech
                      origins, their exact measurements of the flow make them invaluable tools to understand the drift
                      of floating objects and oil spills, relevant for fisheries, search and rescue and shipping
                      operations.
                    </p>
                    ...
                    <p>
                      ...
                      drifters were deployed using the DPIE <em>RV Bombora</em>, measuring the top 10 cm of the ocean
                      and allowing comparison with the measurements of surface currents from the Newcastle HF radar
                      system. However, the challenge in trying to understand what causes particles to reach the shore is
                      that one ends up with your instruments washed up in all sorts of remote locations. This has meant
                      that little is known about the final process of beaching, due to researchers being worried about
                      losing their instruments!
                    </p>
                    ...
                    <p>
                      A week later, following a few days of strong onshore winds, the two other drifters landed.
                      Physalita washed up on the beach in Worimi National Park, where she was picked up by NPWS rangers,
                      while the 3rd float, Tito, made its way into a narrow gully in the rocks north of Wollongong.
                      Thanks to the help of these local organisations, all three floats are now en-route for another
                      deployment, and hopefully more of this rare data on what causes beaching events.
                    </p>

                    <p>
                      As a more conventional part of the same experiment, another type of drifter was deployed at the
                      same time. Part of the NOAA “Global Drifter Project”, these 10
                      ...
                      ), and transports offshore water and material from the deep ocean to the coast. It is
                      characterised by complex ocean dynamics and strong instabilities, as seen in the drifters'
                      trajectories: swirling, diverging paths and quickly evolving currents (Figure 2). These
                      trajectories can be tracked on the
                    ...
                    <p>
                      <em>
                        ...
                        UNSW land-based team Moninya Roughan and Michael Hemming. Thanks to the Sydney Institute of
                        Marine Science, Coledale lifeguards, NPWS teams, Mark Armstrong and Mitchell Fischer from the
                        Department of Defence. If you see these floats in the ocean, please leave them where they are.
                        If you see them on the beach, please get in touch (
                  ...
                  <div className="col-md-3">
                    ...
                    <p>
                      Figure 2: Trajectories and beaching locations of Physalito, Physalita and Tito, as well as the
                      paths and sea surface temperature measured by the SVP drifters. Background arrows indicate the
                      geostrophic currents on the 17th of November.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="row">
                  <div className="col-md-9">
                    <p>
                      ...
                      this week” to the ABC. Let's look at some imagery, starting two weeks back (Fig. 1), or even
                      better,
                      <a
                    ...
                    <p>
                      ...
                      been just days before. By 11 Jan this water has reached the latitude of Narooma, where it starts
                      to wrap around a warm-core eddy that was already there. On 17-19 Jan, some of this very warm water
                      can be seen flowing onto the continental shelf, right up to the coast. By 21 Jan (Fig 2) there is
                      24 deg water over the whole shelf for about 100km.
                    </p>
                    ...
                    <p>
                      ...
                      conditions beyond 100 to 300km away – most of the Tasman Sea is not anomalously warm at the
                      moment. But the potential for local effects cannot be denied. Events such as this one can bring
                      warm water species to the region that would not normally be there. And what just occured this year
                      <a
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  <div className="col-md-9">
                    ...
                    <p>
                      The favourable tidal 'window' in the Banks Strait will be open between 11 pm on the 27th to 4 am
                      on the 28th of December AEDT (see Figure 1). To make this window, boats must sail an average of
                      4.4 to 6.4 knots along the rhumb line from the start at Beauty Point. Slower boats will encounter
                      adverse current in Banks Strait, which peaks at
                      <a
                    ...
                    <p>
                      ...
                      , sits well offshore, but inside the continental shelf southward currents have persisted in the
                      last few days. These have been temporarily strengthened by northerly winds, with peak flow between
                      the 200 m and 1000 m isobaths.
                    </p>

                    <p>
                      Lastly, further south – between Maria Island and Storm Bay – a weak adverse northward current of
                      0.1 to 0.5 knots is sometimes present inshore of the shelf edge. This is bringing cooler 14 °C
                      water up along the coast, compared to the warm 17 °C water flowing southward further offshore
                      (Figure 2). A southwesterly wind change predicted late on the 27th of December may strengthen this
                      current a little further. Depending on the wind conditions, sailors may want to avoid tackling
                      this current head-on during their approach to Tasman Island.
                    </p>
                ...
                <div className="row">
                  <div className="col-md-9">
                    ...
                    <p>
                      ...
                      retroflection, carrying 23 to 25 °C water, curves from the southwest to the south and then into
                      the east-northeast. This retroflection is likely to sharpen further and curve back on itself until
                      a warm core eddy is “cut off” from the main flow. Warm core eddies in this region tend to move
                      southwestward towards the continental shelf edge, and they have favourable currents on their
                      western side. The edge of the eddy is just starting to reach the rhumb line, but the strongest
                      currents of 1 to 2 knots will be felt by those boats who choose a more offshore route between 35
                      and 36 S.
                    </p>

                    <p>
                      The second feature may be a controlling factor in the tactics of the race. It is a strong warm
                      core eddy in Bass Strait, quite far west, currently estimated to be at 39 S 151 E.
                    </p>
                    ...
                    <p>
                      ...
                      to 250 m depth. This explains why the eddy isn't obvious in the sea surface temperature (SST)
                      plots, but stands out in the sea level anomaly contours.
                    </p>

                    <p>
                      Also in Figure 1 you can see the small pink arrows of a drifter track skirting anti-clockwise
                      around the bottom of the eddy. There is a slight north-south offset between the drifter track and
                      the black arrows from the IMOS analysis which suggests that the eddy is slightly further south
                      than the analysis has it.
                    </p>
                    ...
                    <p>
                      The third feature is a broader and weaker warm core eddy centred at 42 S 150 E. Favourable
                      currents associated with the eddy extend from the continental shelf edge and up to 70 nm offshore.
                      This will benefit almost all boats on their journey down the Tasmanian coast. However, keep in
                      mind that closer to shore the currents can be wind-driven.
                    </p>

                    <p>
                      Another aspect to consider is the SST along the course. The waters off Sydney are around 1 °C
                      cooler than normal due to a weak cold-core eddy off the central-north NSW coast along with recent
                      upwelling. However, once the boats enter the warmer waters of the EAC at 35 S, the SST anomaly
                      will flip into the positive. From there, along most of the EAC Extension pathway to southern
                      Tasmania the SST anomalies are 1 to 1.5 °C, in contrast to
                      <a
                      ...
                      . This should encourage more locally consistent winds but may hamper the development of sea
                      breezes closer to land.
                    </p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  possibly thriving on all the phytoplankton) have been seen on the Tas east coast? If so, there might
                  be even more on the west coast. But why is the bloom only on the shelf? Perhaps there is nutrient
                  enrichment happening due to upwelling. The winds on 25-26 October were certainly very strong and
                  upwelling-favourable. Or could there be enough tannin in the coastal runoff to explain this? The
                  inshore waters have certainly been very brown.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <span>
                    . Monthly mean sea surface temperature (SST) anomalies, averaged over sub-regions of the Great
                    Barrier Reef (GBR) help quantify the heat stress (Figure 1). Although there can be a lot of
                    variability at the reef-scale within each region, the bleaching events (indicated with grey) mostly
                    coincide with high SST anomalies in January, February or March (indicated with pink) when sea
                    surface temperatures are at their hottest. Some of the largest anomalies have occurred during the
                    winter months (particularly following an El Niño event: 1998, 2010 and 2016). Wintertime anomalies
                    do not cause bleaching as the absolute temperatures are well below the summertime bleaching
                    thresholds, but may contribute to priming warmer waters at the start of the following summer.
                  </span>
                </p>
                <p>
                  <span>
                    ...
                    Bleached reefs were observed from the north to the south predominantly along the coast but many of
                    the outer reefs were spared (Figure 1). The number of days of SST above the 90th percentile in
                    summer (1 January – 15 March) provides an estimate of the summer heating pattern (Figure 2). Heating
                    was the most persistent in the south with many places on and off the shelf experiencing 15-30 days
                    of extreme temperatures. The narrow band of yellow (&lt;10 extreme heat days) along the outer edge
                    of the southern GBR may explain the lack of bleaching in this region despite the inshore reefs
                    suffering. Cooling at the outer shelf is a feature of the far northern and southern GBR with mean
                    temperatures{' '}
                  </span>
                  <span lang="EN-GB">
                  ...
                  <span>
                    ...
                    southern GBR. This cooling is clearly invaluable in times of severe heating but can be diminished
                    with a deeper surface layer or warmer sub-surface waters.
                  </span>
                </p>
                <p>
                  <span>
                    Bleaching of inshore reefs in the Northern GBR is not explained with the number of marine heatwave
                    days and this could indicate that cloud has impacted the estimate of the true number of heatwave
                    days in this region or that other factors (e.g. prior bleaching) are implicated. Note, usually when
                    assessing for the presence of a marine heatwave (MHW) only contiguous days are counted but the
                    presence of cloud can make this statistic difficult to calculate using the high-resolution AVHRR
                    SST. In this case we are simply looking for the pattern of heating, noting that using the one-day,
                    night-only composites of SST (L3S-1d.ngt) provides a lower estimate of the number of marine heatwave
                    days due to the presence of cloud. For more information about factors affecting reef survival see
                    the
                    <a
                      href="https://nesptropical.edu.au/index.php/factsheets-round-4/"
                      target="_blank"
                      rel="noreferrer"
                    >
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  next 40 hours drifting southward with a small life raft and an icebox. He knew that he had to get to
                  shore before he reached Cape Byron or he would be swept out to sea by the East Australian
                  Current.&nbsp; EAC pioneering observer George Cresswell assisted the Australian Transport Safety
                  Bureau's 1996 investigation into the events&nbsp;surrounding the sinking of the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  An ocean glider, deployed on the southern Great Barrier Reef (GBR), has captured the vertical profile
                  of temperature (right) indicating the extreme temperatures at the surface had extended right to the
                  bottom during the last days of the marine heatwave. From early February to mid-March, sea surface
                  temperatures (SST) were higher than the 90th percentile (based on the SSTAARS climatology) over much
                  of the southern half of the Great Barrier Reef, with large regions experiencing temperature anomalies
                  double the 90th percentile anomaly for 7-10 days. Aerial surveys of the reef indicate a
                  <a
                  ...
                  southerly winds developed, long enough to observe that it took over 2 days for temperatures at depth
                  ...
                  <span>
                    ...
                    temperature anomalies in the region remained above 1.5°C from early February to 9 March and above
                    2°C for over 3 weeks. Given the slow build of two weeks to peak SST in mid-February it is very
                    likely these surface temperatures would have extended to the bottom in shallow (&lt;40m) regions.
                    Although there are cloudy periods, temperatures do not appear to have abated at all in that time.
                    The data from this glider mission is available on the
                    <span className="MsoHyperlink">
                  ...
                  <br />
                  <br />
                  ¹The mean vertical structure of GBR1-SSTAARS is calculated from the 1km resolution model, GBR1 for
                  every location on the SSTAARS 2km grid. This type of projection is particularly useful in a highly
                  frictional region like the GBR where bathymetry plays a big part in determining the extent of vertical
                  mixing. Seasonal winds strongly affect the mixed layer depth and, with only 5 years of model output
                  available, the climatology may not fully represent the long term mean. However, bathymetry and tidal
                  currents also contribute significantly to vertical structure, particularly in shallow regions, and
                  these factors can be considered persistent. Note: this climatology is yet to be fully evaluated but
                  could provide a significant resource not just for assessing observed temperatures but also identifying
                  locally important physical processes. The work to produce GBR1-SSTAARS was undertaken under
                  <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  multiply and this productivity can be seen with images of Chlorophyll-a. The complexity of the
                  response is evident in the image from March 11 (Figure 2). The bloom is strong at the edges of the
                  plume while there is almost nothing happening at the centre. This pattern probably reflects the
                  strength of the upwelling event. Water that is upwelled initially (at the outer edge of the plume in
                  this case) will have brought phytoplankton up from the mixed layer (where phytoplankton are often
                  found). Whereas the lack of pigment at the centre of the plume suggests the water has come from well
                  below the mixed layer and it will take a little time for the phytoplankton response to develop in this
                  water. In later images, e.g.
                  <a
                ...
                <p>
                  <span>
                    ...
                    velocities (red arrows) from the SA Gulfs radar indicate north-westward velocities of up to 0.4m/s
                    on the shelf. It certainly would have been a good time to have the scheduled Bonney Coast glider
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <span>
                    The Port to Pub swim from Fremantle to Rottnest is coming up on Saturday March 21. Like last year,
                    we have the
                    <span className="MsoHyperlink">
                ...
                <p>
                  <span>
                    In the water between Perth and Rottnest, the currents are usually strongest near Rottnest Island,
                    and they are
                    <span className="MsoHyperlink">
                      <a
                    ...
                    little more than the Rottnest swim because of the northward direction of the swim – the currents
                ...
                <p>
                  <span>
                    ...
                    Wednesday for the race day forecast! Look for the green 'Port to Pub' button on the OceanCurrent
                    home page.
                  </span>
                </p>
                <p>&nbsp;</p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  the GBR and outer parts of the southern GBR. However, there are still regions in the south,
                  particularly in inshore regions, which are over 2°C above average. In the far north, the outer reef
                  stayed relatively cool but the waters of Princess Charlotte Bay were 1-2°C above average. The
                  occasional glimpse through the clouds indicates Princess Charlotte Bay cooled a little in late
                  February (
                  <a
                  ...
                  ) but the most recent image shows it has begun to warm again. The AIMS in-water temperature loggers
                  are in general agreement with the SST. All loggers indicate that temperatures have fallen below or are
                  close to the 'normal' range (defined as within 2 standard deviations of the daily average). The
                  ...
                  we have ranked our daily images of SST in terms of how much each observation exceeds the climatology
                  in factors of the 90th percentile: from no heatwave (&lt;90th percentile) then increasing from
                  Category I (moderate, a factor of 1-2) to Category IV (extreme, more than 4 times the 90th
                  percentile). This ranking indicates that a large proportion of the southern half of the GBR
                  experienced a Category II MHW for a number of days and most of the rest of the reef experienced
                  Category I for at least 2 weeks. Many parts of the reef are still experiencing Category I conditions
                  (and even Category II in places) so those areas appear to be still under threat.
                  <br />
                  <br />
                  ...
                  <span>
                    ...
                    (off Hinchinbrook Island) indicate significant cooling over 20m of the surface layer. Glider
                    location will often account for variability in glider temperature records however this glider was
                    held in effectively the same location for two periods Feb 14-16 and Feb 20-24. During the first
                    period temperatures of 30.5°C were observed down to 20m depth whereas during the second the by top
                    20-30m cooled to at least 28.5°C. This represents a cooling of at least 2°C throughout the surface
                    layer. Although autumn has officially begun, further heating is still possible, particularly through
                    advection, as
                    ...
                    <br />
                    Hobday, A.J.,&nbsp; E.C.J. Oliver,&nbsp; A.Sen Gupta,&nbsp; J.A. Benthuysen,&nbsp; M.T.
                    Burrows,&nbsp; M.G. Donat,&nbsp; N.J. Holbrook,&nbsp; P.J. Moore,&nbsp; M.S. Thomsen,&nbsp; T.
                    Wernberg,&nbsp; D.A. Smale, 2018. Categorizing and naming marine heatwaves. Oceanography 31(2)
                  </span>
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  <br />
                  While cloud cover provides great protection for the reef, particularly during this time when reef
                  waters are already at their hottest, it clearly blocks observations using satellite AVHRR SST.
                  In-water observations, however, are ongoing and
                  <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <span>
                    Sea surface temperatures on the Great Barrier Reef (GBR) south of latitude 15°S were close to
                    average in the first half of summer but they began to increase in mid-January, and have been above
                    the 90th percentile since Feb 10. Mid-February is the time when water temperatures are usually at
                    their maximum so this is the danger period for coral bleaching. Time series of the last 21 years of
                    SST in two 50x50km regions of the reef (Figure 2) show that recent water temperatures have rapidly
                    become extreme and are on a par with those observed in the GBR's four previous mass coral bleachings
                    in 1998, 2002, 2016 and 2017. The routinely scheduled
                    <a href="http://oceancurrent.imos.org.au/gliders/GBR20200123_nrt_4d/GBR20200123_nrt_4d.mp4">
                      glider mission
                    </a>
                    sampling in the central GBR indicates that, since Feb 10, these temperatures of 30-31°C extend down
                    to 25m depth.
                  </span>
                  <br />
                  <br />
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <span style={{ fontSize: '11pt' }}>
                    ...
                    layer, providing a readily available <span>&nbsp;</span>source of cool water. The three cyclones
                    that developed in January and February of this year were not particularly strong (only TC Damien
                    reached Category 2) but each of them left a path of cooled water in its wake.
                    <br />
                    <br />
                    TC Blake (Jan 6-8) travelled north to south between the two largest reef groups on NWS, Rowley
                    Shoals and Scott Reef, closely followed by TC Claudia (Jan 10-18), also passing close to Rowley
                    Shoals and Scott Reef, this time travelling westward. The
                    <a
                    ...
                    across the shelf allowed for particularly good vertical mixing and rapid cooling over the western
                    end of NWS. Strong and persistent upwelling winds along the northwest corner of Australia which
                    began in the last week of January brought
                    <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  summers (Figure 2) shows that the band of westerly winds over the Southern Ocean was much further
                  north in both Jan and Dec 2019 compared to Jan 2018 when there was a marine heatwave off South Island.
                  The strong westerly winds with associated fronts cause strong vertical mixing but, also, when
                  interacting with the New Zealand land mass, produce upwelling winds on the west coast. South Island
                  ...
                  pattern that is not associated with upwelling as it is largely occurs in deep water and east coast
                  winds have been mostly downwelling favourable over the last month. The cool water around New Zealand
                  is in sharp contrast to the anomalously warm region to the east of New Zealand
                  ...
                  more so. Upwelling is significant, of course, because it brings nutrient rich water to the
                  phytoplankton in the surface layer and so can power the entire food web.
                </p>
                <p>&nbsp;</p>
              </div>
            </article>
          ...
          <div
            className={cn(
              'flex flex-col gap-y-8',
              selectedFilter !== null && selectedFilter !== 'older_than_2020' && 'hidden',
            )}
          >
            <article className="p-2">
              <div className="flex items-center justify-between rounded bg-[#F1F6F9] p-4">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Boxing Day afternoon. Boat speeds will be assisted by a new lobe of the East Australian Current that
                  has moved down past Sydney's latitude, offering favourable southward currents outside the continental
                  shelf edge down to Jervis Bay.
                  <br />
                  <br />
                  ...
                  offers southward current of 2 to 2.5 knots on its western side. This eddy is quasi-stationary and can
                  be found beyond the 1000 m isobath to the east of Gabo Island.
                  <br />
                  <br />
                  Another large anti-cyclonic eddy lies to the east of Hobart. It has been moving slowly southward and
                  the centre of it now lies south of the finish line.&nbsp; However, boats approaching Tasman from a
                  wide angle may gain an extra 1 knot of favourable current on the northwestern edge of this feature.
                  This may be particularly valuable during another period of variable winds expected on the 29th of
                  December.
                  <br />
                  &nbsp;
                </p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  defined as five or more days when the sea surface temperatures (SST) are warmer than 90 per cent of
                  the previous observations at the same time of year. The majority of this coastline has experienced SST
                  anomalies at &gt; 90th percentile (Figure 1).
                  <br />
                  <br />
                  The duration of 90th percentile SSTs varies around the coastline. Temperatures have been most severe
                  in Shark Bay which has seen 90th percentile SST since early December. In other parts, the extreme
                  temperatures have only begun very recently. They have, however, coincided with spring tides which
                  bring both extreme high and low sea levels. Solar heating has greatest impact on shallow waters, and
                  the combination of strong diurnal heating with low spring tides are believed to have contributed to
                  the deaths of tiny crabs in Karratha mudflats, wild oysters at the mouth of the Fortescue River on the
                  ...
                  has resulted in extended periods of very low sea level throughout the daytime, allowing maximum
                  heating of shallow waters.
                  <br />
                  <br />
                  Ocean temperature time series obtained from the continental shelf region off Two Rocks (~ 50 km north
                  of Fremantle) by an ocean glider indicated the warming over a two week period.&nbsp; Initially, the
                  ...
                  north-easterly winds. The trough inhibits the usually strong southerly winds that bring cooler air
                  from the south and which also generate upwelling that mitigates the warming.&nbsp; This can be seen
                  off the Ningaloo coast where over the past two days locally strong southerly winds have generated
                  upwelling and the Ningaloo Current creating a band of colder water adjacent to the reef thus
                  mitigating the warmer temperatures.&nbsp; Shark Bay in contrast remains warm (Figure 3).
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Sailors racing to Hobart will be on the lookout for favourable ocean currents to give them an extra
                  knot or two in speed. The race course this year offers three good opportunities. A large anti-cyclonic
                  eddy sits offshore from Gabo Island, providing favourable southward currents down the western side.
                  The centre of the eddy has been quasi-stationary for months and is not expected to move much before
                  start time. The strongest flow is over 2 knots and is located several miles outside the continental
                  shelf edge, beyond the 1000m isobath. It would be a slight detour from the rhumb line to enjoy this
                  extra push.
                </p>
                <p>
                  The second feature of interest is a small anti-cyclonic eddy lying midway across the Bass Strait on
                  the rhumb line (Figure 2). It is not easy to see on SST charts, but can be seen in
                  ...
                  larger one, but before it does there is a weak southward current of up to 1 knot down the western
                  side.
                </p>
                <p>
                ...
                <p>
                  ...
                  from the east. The eddy has been moving south-southwestward over the last six weeks. Depending on how
                  it moves in the next few days, by the time of the race it may be either conveniently close to the
                  shelf edge adjacent to Tasman Island, or further south and difficult to use.
                </p>
                <p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  (Figure 2) is striking and suggests that direct atmospheric forcing is the principal cause as opposed
                  to advection. Where November winds were consistently light (generally associated with atmospheric
                  highs and clear skies) sea surface temperatures (SSTs) are relatively high (but may be only shallow),
                  whereas where winds have been strong, any solar heating will be mixed deeper resulting in cooler
                  surface temperatures. Of course, cold fronts and cloud cover will also limit the sea surface
                  temperatures.
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  The question then is: how deep does the heat go? Argo floats, particularly when referenced to a 3D
                  ocean climatology (e.g.
                  ...
                  &nbsp;
                  <br />
                  In the west and northwest, where winds have been very light, SSTs are in the top 80-90th percentile
                  for this time of year. Recent Argo temperature profiles (e.g.
                  ...
                  stratification and also can provide rapid surface cooling in the event of strong winds. This cold
                  water is probably a consequence of the strongly positive
                  ...
                  <br />
                  <br />
                  Around New Zealand,&nbsp; weak winds have also warmed the surface waters to the north and east. An
                  Argo profile from the
                  ...
                  as the strong winds and embedded fronts persist. Surface temperatures are at their coldest 10% and
                  Argo profiles (e.g. offshore from Kangaroo Island,
                  ...
                  atmosphere/ocean interactions and can be very different from offshore. However, the large scale
                  offshore ocean conditions observed by Argo floats will contribute to determining coastal conditions.
                  <br />
                  &nbsp;
                </p>
                <p>&nbsp;</p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  below average (Fig. 1). Over the last few weeks temperatures all around Tasmania have cooled with the
                  strong winds associated with the passage of a number of fronts through the region. This atmospheric
                  cooling appears to be quite widespread but, depending on the weather of course, may not be very
                  long-lasting. An Argo float offshore which profiled on Nov 3 and Nov 13, shows the shallow warm
                  surface layer that had developed by
                ...
                <p>
                  ...
                  all along the east coast shelf. Whether the water is an intrusion of cold offshore water onto the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  have preferences for habitats that aren't too hot or too cold, and where currents aren't too strong or
                ...
                <p>
                  ...
                  predict climate-driven range shifts and serve as decision-support tools for conservation planning and
                  adaptive fisheries management. While these applications rely on the ability of habitat models to
                  estimate where a species is likely to be present or absent within the environment, there has been no
                  evidence to suggest these models are useful for predicting the health or condition of marine
                  species…until now.
                </p>
                <p>
                  <br />
                  ...
                  from eastern Australia (Figure 1). Our kingfish habitat model incorporated three oceanographic
                  variables, sea surface temperature, sea level anomaly and eddy kinetic energy, allowing habitat
                  suitability to be estimated at varying time-before-fish-capture periods. Our results revealed a strong
                  correlation between modelled oceanographic habitat suitability and field-derived measurements of
                  kingfish body condition (Figure 2). This relationship was evident when habitat suitability predictions
                  used oceanographic variables measured one to four weeks before fish condition was measured.
                </p>
                <p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  eddies and their pathway is usually determined by the surrounding currents. &nbsp;These
                  characteristics make frontal eddies quite elusive, so although they are often seen with satellite SST,
                  their subsurface structure has only occasionally been sampled. Interestingly, the small cold-core eddy
                  that is contributing to diverting the EAC, is also capturing frontal eddies. The freddies are seen to
                  form just east of Fraser Island, then move south along the frontal edge (for about 7 days) until they
                  are entrained into the cyclonic (cold-core) eddy (Figure 1).&nbsp;When a freddy interacts with the
                  coast, it can entrain shelf waters along with any zooplankton and larval fish that may be present. As
                ...
                <p>
                  ...
                  array and on board, Iain Suthers and a team of biologists are collecting&nbsp;samples of larval fish
                  and the fine zooplanktonic food. They will measure the growth and mortality rates of larval fish in
                  ...
                  eddies contain an abundance of species spawned inshore, including larval sardine. The working
                  hypothesis is that these frontal eddies are an offshore nursery ground&nbsp;that contributes to future
                  recruitment to inshore fisheries.
            ...
            <article className="p-2">
              <div className="flex items-center justify-between rounded bg-[#F1F6F9] p-4">
                <div>
                  <h3 id="Cold_core_eddy_diverts_EAC_waters_offshore_replacing_it_with_cold_water">
                    <a
                      href="#Cold_core_eddy_diverts_EAC_waters_offshore_replacing_it_with_cold_water"
                      className="anchor"
                    >
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  , the eddy moved closer to the outer continental shelf (right over the outer moorings of the EAC
                  array) and started to divert part of the East Australia Current (EAC) offshore just north of the
                  array. By
                ...
                <p>
                  The combined effect of these events on the waters off northern NSW is most evident in the SST
                  anomalies and percentiles. As the eddy was starting to divert the EAC, temperatures all along the
                  shelf and slope south of Brisbane were largely in the top 10-20% (Figure 1, left). Four weeks later,
                  with the EAC still being diverted and the cold core eddy bringing cool waters into the region,
                  temperatures along the shelf were below average and over the slope were in the coldest 10-20% (Figure
                  1, right). Where the patch of cooler water in the cold-core eddy came from, whether advected from
                  elsewhere or even upwelled, is not clear from the 6-day composite SST. &nbsp;From the Four-Hour SST,
                ...
                <p>
                  With a lot of the action happening right over the EAC array it is an exciting prospect that we will
                  get back more information about what was happening below the surface. Even more so, because the RV
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  not only true for isolated predictions derived from current meter observations, but also for
                  predictions from a model (TPXO9) that uses satellite measurements of sea level to make its predictions
                  more accurate.&nbsp;Where tides are moderate to strong, the model predictions generally agree with the
                ...
                <p>
                  ...
                  section of our website presents the details of our assessment of the errors of tidal predictions.
                  Users will find various sorts of plots and maps to address two important questions: "how much of the
                ...
                <p>
                  ...
                  . The flow oscillates purely parallel to the coast at a point off the northern Kimberley where the
                  tidal range&nbsp;is relatively small. East of Darwin, in contrast, the tide is largely progressive,
                  travelling eastward (click forward on the map above) into the Gulf of Carpentaria, with a whole
                  wavelength fitting into the Arafura Sea. Localised amplification of the tide exists either end of
                  Torres Strait. Continuing clockwise around Australia, the next major feature is the amplified tides
                  near Mackay and Rockhampton. Tidal currents are relatively weak from Fraser Island to Gabo Island
                  (excepting entrances to harbours) so mariners off SE Australia are much more interested in predictions
                  of what the East Australian Current is doing. Bass Strait has amplified tides, with
                  <a
                  ...
                  to produce a maximum tidal range near Burnie on the Tasmanian side. The South Australian Gulfs also
                  have significant tides,
                  <a
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  , the eddy travelled west through the Coral Sea and now sits on the continental shelf edge just east
                  of Innisfail. The feature is weakening and is hard to see on SST images as the cold-core remains under
                  the surface, but the eddy can be spotted through sea level anomalies (Figure 1). The eddy is drawing
                  down warm South Equatorial Current water on its eastern side. The currents then wrap around and move
                  towards the shelf edge on the southern side. When they hit the shelf, the currents bifurcate: some of
                  the flow going northward along the coast, and some of it southward. The bifurcation point is
                  at&nbsp;19-20°S&nbsp;on the southern side of the eddy.
                  <br />
                  &nbsp;
                </p>
                <p>
                  However, this is not normally the case. Usually the bifurcation point is about 300km further north,
                  near 14.5°S.&nbsp; Studies show that the SEC forms into two jets: the shallow North Vanuatu Jet (NVJ)
                  which reaches the coast at 14.4-14.7°S, and the deeper North Caledonia Jet at 18°S (
                  ...
                  Meteorology's ocean model) to compare the ocean currents at depth (Figure 2) we can see that at the
                  same time last year the&nbsp;bifurcation at the surface&nbsp;was a lot further north. The currents
                ...
                <p>
                  ...
                  seabed. Notably, the current is all in the same direction. The TC Oma eddy is disrupting the normal
                  flow of the North Vanuatu Jet (part of the South Equatorial Current) into the coast. This diversion of
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  Marine heatwaves have become more frequent around the globe and Australia is no exception. In the
                  ocean, heatwaves are usually described by their surface expression through satellite SST but the
                  subsurface extent is not so readily discovered. Argo profiles have transformed our knowledge of the
                  deep ocean but, with a 2000m dive program, they are not designed to measure in more shallow regions.
                  Coastal regions, however, are where our coral reefs, kelp forests and sea grasses grow, providing
                  ...
                  and the 13°C water the glider sampled at the bottom on the outer shelf. EAC water was not far
                  offshore, however, and on the return transect the glider finds a sharp front in temperature (and
                  salinity, not shown) as it crosses into the
                ...
                <p>
                  ...
                  break all along the northern half of the shelf. The data from these glider missions provides a wealth
                  of information to help develop an understanding of the mechanisms that affect temperatures in the
                  waters off Tasmania's east coast: surface heat fluxes, regional circulation, the EAC and upwelling.
                  The glider missions are run by the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  Before threatening south-eastern Queensland back in February, Tropical Cyclone Oma spent a week
                  causing great damage to Vanuatu and New Caledonia, even sinking a bulk carrier&nbsp; with a US$50
                  million clean-up bill. It was the three days, 15-17 Feb, when the cyclone slowed and intensified, that
                  it made a deeper, long-lasting impression on the ocean. The
                ...
                <p>
                  ...
                  <br />
                  Ocean eddies, unhindered by a land barrier, propagate westward and TC Oma's cold-core eddy has
                  travelled over 1600km across the Coral Sea in the five months since it formed. Its surface temperature
                  signal has almost disappeared but it is still evident in the altimetry although weaker and smaller. By
                  chance it came in just south of the Coral Sea Islands and north of Marion Reef, and was corralled into
                  a relatively narrow, shoaling ocean channel. The currents associated with the eddy as it crossed the
                  Coral Sea were quite strong for this part of the ocean, over 0.5m/s at the surface, and appear to have
                  had an unexpected effect on temperatures on the Great Barrier Reef (GBR). The southward current on the
                  eastern side of the eddy as it approached the outer shelf appears to have advected anomalously warm
                  Coral Sea water not only onto Marion Reef (Figure 2) but
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Australia when the ocean normally starts to lose more heat to the atmosphere than it gains through
                  solar radiation, the south west shelf temperatures are up to 3° colder than usual (see
                  ...
                  are in the coldest 10% (Figure 1). Winter cooling is usually greatest in shallow coastal waters
                ...
                <p>
                  Temperatures off WA are affected by the strength of the Leeuwin Current which transports warm water
                  from the tropics southward along the shelf break. The Leeuwin Current partly relies on the warm pool
                  of water north of New Guinea which is at a maximum during La Niña events, such as in
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  scientists to study the physical, chemical and biological oceanography of the same region as part of
                  the first International Indian Ocean Expedition. During the 2019 voyage, which is Australia's major
                  ...
                  scientists is repeating many of the measurements made nearly six decades ago to ascertain if there
                  have been significant changes in the pelagic ecosystem near the western extent of Australia's
                  Exclusive Economic Zone. The voyage is led by Professor Lynnath Beckley of Murdoch University and the
                  research is supported by a grant of sea time on RV <em>Investigator</em> from the CSIRO Marine
                  National Facility.
                  <br />
                  &nbsp;
                </p>
                <p>
                  During voyage IN2019_V03, in addition to repeating the CTD profiles of temperature and salinity, we
                  will carry out a diverse range of water sampling to help measure the foundation of the ocean food
                  chain. We'll be towing an IMOS Continuous Plankton Recorder between stations along the 110°E line and,
                  at each station, Claire Davies from CSIRO is deploying a Heron net to sample zooplankton in the
                  surface waters in the same way it is collected at the IMOS reference station network around Australia.
                  Water samples are being taken to determine their microbial constituents as part of the Australian
                  Marine Microbiome Initiative. In addition, water from the Niskin bottles on the CTD rosette is
                  ...
                  regular deployment along the 110°E line for the Bureau of Meteorology and NOAA. We have already
                  deployed an APEX deep ARGO float (6000 m depth capability) for our Japanese colleagues at JAMSTEC and
                  have a further one to deploy later in the voyage. This exciting addition to the voyage came about from
                  discussions during the annual meeting of the IIOE-2 steering committee in March 2019 in Port
                  Elizabeth, South Africa. With some careful logistics, including airfreight from Tokyo to Sydney and a
                  road journey by truck across the Nullabor, the floats reached Fremantle just in time for the start of
                  RV <em>Investigator</em> voyage!
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  (Figure 1). Despite the 12d delay since the rains the glider found an 8m deep plume of relatively
                  fresh water. It also found that water was 3°C warmer than satellite and ship measurements of
                  temperature just 2 weeks earlier on
                ...
                <p>
                  ...
                  over the shelf after the rain stopped. For example, soon after the rain on Feb 14 (Figure 2) SST is
                  well over 31°C while just 1.9m below the surface, ship temperatures were up to 4° cooler. The classic
                ...
                <p>
                  ...
                  been warm relative to the reef water and contributed to faster heating. Observations from RV Solander
                  in early February indicate that the opposite is true. The ship measured a fairly steady 27.5°C
                  everywhere that salinity was in the normal range but when the intake was fresh, temperatures were as
                  low as 15°C. It is more likely then, that the strong salinity gradient due to the plume and the
                  temperature gradient due to surface heating, combined to form a highly stratified system that inhibits
                  mixing, particularly given winds were weak at the time. Furthermore, incoming shortwave energy is
                  attenuated in the upper 1-2m of the river plume water due to its dark color, further enhancing the
                  stratification.
                  <br />
                  &nbsp;
                </p>
                <p>
                  The glider observed the dissipation of the heat with the strong south-easterly change that came
                  through after Feb 25 which mixed the entire water column and eventually brought cool water from the
                  outer reef into the region. And as the winds calmed in mid-March the beginning of diurnal heating can
                  be seen again. As for the fresh plume, it disappears with the strong winds and yet shelf salinity was
                  still sub-35 PSU, well below the normal salinity range, for the remainder of the deployment.
                  <br />
                  &nbsp;
                  <br />
                  &nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  , SST percentiles indicated temperatures turned out to be significantly warmer (in the highest 20%)
                  than the forecast.
                </p>
                <p>
                  ...
                  that developed over North Queensland and then Tropical Cyclones Penny, Oma and now Trevor. The
                  ...
                  has a catchment area west of the Great Dividing Range. On Feb 11, the sediment laden plume was seen to
                  extend 60km across the shelf (Figure 2) and a few days later, after the wind turned offshore, it
                  reached
                  ...
                  them to affect the outer reef. The sediment in the river plumes will eventually settle out,
                  potentially smothering seagrasses and corals. The plume waters themselves bring nutrients and often
                  result in large increases in microbial and planktonic blooms. On the positive side, benefits include
                  increased prawn production and food for other larvae.
                  <br />
                  &nbsp;
                  <br />
                  &nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Swim conditions for the Port-to-Pub this Saturday could be challenging! The ocean current forecast
                  from the Oceans Institute of UWA is for strong northward currents for the second half of the course
                  ...
                  throughout the day and total wave height (swell + wind waves) of 1.5-2m from the southwest. So it
                  could be quite choppy with a strong push to the north. Air temperatures are forecast to be warm, 27°C
                  at the coast, and
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  in a large area, around New Zealand. Both heating events occurred under the influence of a blocking
                  high in the Tasman but the location of the high and the nature of the disruptions to the high created
                  quite different conditions off the west coast of New Zealand (Figure 1). In 2018, satellite SST shows
                  surface water off the west coast was more than 3°C above average for the last 10 days of January and
                  coastal waters
                ...
                <p>
                  ...
                  established itself just east of New Zealand. It was also preceded by a series of weak low pressure
                  cells (e.g. Figure 3, left) that created a period of about 10 days of downwelling winds along the west
                  coast of South Island (Figure 2, top). In contrast, in January 2019, the blocking high remained over
                  the centre of the Tasman and throughout the month and South Island experienced a series of
                  south-westerly wind episodes (Figure 2, bottom) caused by disturbances in the air flow south of New
                ...
                <p>
                  The SAM, or Southern Annular Mode, is considered to be the strongest indicator for blocking highs in
                  the Tasman (Salinger et al, 2019)¹. There is an increasing trend in the SAM&nbsp; with climate change
                  so it is thought that marine heat waves associated with blocking highs could become more prevalent.
                  The
                  <a href="https://legacy.bas.ac.uk/met/gjma/sam.html">SAM index</a> was high in both January 2018
                  (2.72) and January 2019 (2.79) and although blocking highs were present in both years they were very
                  different in character and produced different local outcomes. Upwelling has always been valued for
                  bringing nutrients up to the surface, fuelling ocean production, but as ocean temperatures rise the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Conditions are looking good for the swim this year. A weak (&lt;0.5knot) northward current in the
                  second half of the race that turns&nbsp;northwestward around midday may even provide a gentle push in
                  the middle of the race for swimmers still in the water. Neither the wind nor swell look like they will
                  create difficult conditions. The Bureau of Meteorology is forecasting light southerly winds in the
                  morning turning westerly, becoming moderate in the afternoon. Swell is forecast to be
                  small:&nbsp;0.5-1m from the southwest.
                  <br />
                  &nbsp;
                </p>
                <p>
                  The water appears to have warmed up a little near the coast over the last few days. However, when
                  winds have been weak, as they have off Perth for a few days, the satellite SST may only represent a
                  shallow surface layer. To help identify these situations, we include &nbsp;water temperature from
                  ships with a hull-mounted intake whenever it is available. The latest ship SST (Feb 16, bottom right
                  figure) from the vessel Sea Flyte indicates water temperature at 0.5m is 21.5°C, 1°C cooler than the
                  satellite estimate of 22.5°C. This difference in temperature in the surface layer indicates recent
                  shallow heating and the possibility of cooler waters below. However, there have been a few more days
                  of solar heating since Feb16 due to clear skies around Perth, so the water is still warming.
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  February 23. Hourly ocean current forecasts, courtesy of the Oceans Institute of UWA, are shown for
                  the coming Saturday. The forecast for tomorrow, February 16, indicates a strong northward current in
                  the second half of the swim, getting stronger throughout the day. These conditions are particularly
                  hard on swimmers who start the race later in the day and so are more likely to cop the stronger
                  currents. The forecast for the actual race day will be available next Wednesday and updated daily.
                  Although, strong northward currents are common for this time of year,
                ...
                <p>
                  ...
                  this year and a fairly strong Capes Current. The Leeuwin Current brings warm water south throughout
                  the year and is usually strongest in the winter months. The Capes Current is a wind-forced shelf
                  current that occurs mainly in the summer. It can be seen in the 14 Feb SST (right) as a cold tongue
                  stretching north from Cape Leeuwin and Cape Naturaliste. Given the cause of the cool temperatures it
                  is likely they will persist until race day.
                </p>
                <p>&nbsp;</p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  coast and in the Tasman Sea the water is warming. All of these events can be linked to the presence of
                  a blocking high over the Tasman (Figure 1). A high-pressure cell becomes a blocking high when it
                  stalls, staying in about the same place while the surrounding atmosphere moves around it. These highs
                  can persist for several days to weeks causing the areas affected by them to have the same kind of
                ...
                <p>
                  ...
                  the water and go wherever the wind takes them. Off southeast Queensland the winds have been
                  persistently onshore since Christmas bringing any bluebottles that are out there right in to the
                  beach. Along the NSW coast the atmospheric high brought
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  there is an adverse current on the western side of the eddy where the yachts will be wanting to go.
                  This eddy is not particularly large or intense, but it will probably persist until race time (it was
                  much stronger a month ago when it was off Sydney).
                  <br />
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  Oceanographic wisdom is that waters off eastern Tasmania are either south-bound in the 'Tasman
                  leakage' of East Australian Current waters into the Great Australian Bight, or east-bound in the 'west
                  wind drift' of the Sub-tropical Convergence Zone. What do we make, then, of
                  <a href="https://www.abc.net.au/news/2018-09-21/message-in-a-bottle-found-queensland-tasmania/10289798">
                    news
                  </a>
                  that a bottle dropped 12nm east of Bicheno, Tasmania, in November 2016 was found almost 2 years later
                  in Shoalwater Bay, Queensland, in September 2018?
                </p>
                <p>
                  <br />
                  To investigate the likelihood of this trip, we used the same modelling system that we have used on
                  many occasions for simulating or forecasting the long-term drift of items floating on the sea surface
                  (e.g. missing flight
                  <a href="http://www.marine.csiro.au/~griffin/MH370/">MH370</a>). This system uses global numerical
                  models of the ocean and atmosphere, each of which relies on a global network of observing systems to
                  be as accurate as possible. Items floating at the surface get an additional boost from the waves; not
                  so much the swell, but the very short period waves of 1-4s, which travel in the direction of the wind.
                  This effect is called
                  <a href="https://en.wikipedia.org/wiki/Stokes_drift">Stokes Drift</a>
                  and is about 1.2% of the wind velocity. For anything floating above the surface, wind drag, or
                  windage, also becomes important but we can assume it to be negligible for a bottle.
                  <br />
                  <br />
                  We tracked 200 'virtual bottles' dropped in our virtual ocean on 20 Nov 2016 – thought to be the day
                  the family were on their fishing trip. We started the virtual bottles in a tight ring (about the size
                  of the model grid, which is 10km) around the real bottle, so they would all be equally representative
                  of it. The turbulence in the virtual ocean quickly separated the virtual bottles, faster and faster as
                  the distances between bottles increased. This is much the same as would happen if 200 real bottles
                  were dropped at the one spot.
                  <br />
                  <br />
                  Most of the virtual bottles headed for New Zealand, the first making landfall on 22 Sep 2017. This is
                  what we would expect to happen to most of the real bottles if a large number were released. But a
                  small proportion of the virtual bottles did make it to Queensland - some going quite far north. One
                  actually ended up, of all places, in Shoalwater Bay on 7 July 2018 (just a couple of months earlier
                  than the real bottle was located)! Click the image at right to see an animation of the chaotic
                  trajectories of the virtual bottles. The background colour indicates the magnitude of the surface
                  velocity, highlighting the slow-moving eddies. The effect of passing storms (white vectors indicate
                  the wind) on the bottles is evident. Virtual bottles do loops around these eddies, first one, then
                  another, as we know real satellite-tracked drifting buoys do. Occurring randomly with respect to eddy
                  centres, wind or small-scale turbulence nudge each bottle (similarly for real or virtual bottles) in
                  or out of an eddy if the bottle is close to a critical streamline.&nbsp;
                  <br />
                  <br />
                  ...
                  <br />
                  <br />
                  Is there a paradox? Of course not. When we study the world's ocean currents, the focus is on where
                  most of the water goes, not every molecule. Our simulation showed that going to New Zealand was the
                  most likely, but certainly not the only possible, destination of the bottle. We can't really say if
                  the likelihood of going to Queensland was more or less than 1%. But one thing is clear: the trip of
                  that bottle was extraordinary.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  time series (3.22 cm/decade) as shown in Figure 1. It is tempting to estimate the trend for the 8
                  years since 2010 but the large ENSO signal throughout these years makes it difficult to get an
                  accurate estimate. Observations of ice loss, however, give reason to believe the apparent increasing
                  rate of sea level rise is real.
                  <br />
                  &nbsp;
                </p>
                <p>
                  ...
                  complex. When the weight of ice is removed the earth's crust rebounds quickly but there is also a
                  slower rebound in the mantle below. There is some hope that
                ...
                <p>
                  ...
                  global mean sea-level rise over the satellite altimeter era. <em>Nature Climate Change</em>, 5,
                  565-568.
                  <br />
                  &nbsp;
                </p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  New South Wales on 12 August 2018, showed
                  ...
                  below 200 m depth – but nothing remarkable. By 22 August, the same float returned an interesting
                  little “spike” in
                  ...
                  . This spike was isolated to a few tens of metres, relatively small in amplitude, but quite distinct
                  ...
                  degrees and 0.8 psu above normal (Figure 1). Analysis of the TS properties of these profiles (Figure
                  2) shows that the most recent profile has the signature of cooled Bass Strait Water. First
                  observations of the Bass Strait winter cascade were made by Boland (1971) but more recently glider
                  observations indicated high oxygen content in the water mass, confirming it to have had recent contact
                  with the surface, Baird and Ridgway (2012).
                  <br />
                  <br />
                  <strong>
                  ...
                  <a href="http://oceancurrent.imos.org.au/sst.php?link=SE/20180816.html">August 2018</a>. The presence
                  of northward shelf currents, evident in the GSLA, was confirmed by a northward drifting surface
                  drifting buoy. This is also reflected in SST with colder than normal waters adjacent to the coast. It
                  appears that water originating in Bass Strait, with salinity of 35.4 psu, has cooled over winter, left
                  Bass Strait flowing into the Tasman Sea, and drifted northwards along the NSW coast before becoming
                  entrained into a passing eddy at ~600 m depth.
                </p>
                <img
                  alt=""
                ...
                <p>
                  ...
                  almost 300m below the depth of the Bass Strait water recently sampled so it's drift velocity may
                  differ from the Bass Strait water's velocity. We'll have to watch this Argo float #5902378 to see if
                  it samples the Bass Strait water again. The next profile is due to be available on 11 September 2018.
                  <br />
                  <br />
                  <strong>
                    <em>References</em>
                  ...
                  of Bass Strait Water in the centre of anti‐cyclonic mesoscale eddies,&nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  product is now available on OceanCurrent. It uses Himawari-8 SST images (and all other available SST)
                  to provide 6 images per day. Four-hour SST, as its name implies, &nbsp;provides an image every 4 hours
                  ...
                  phenomenon, often called the afternoon effect because it is usually maximum in the late afternoon.
                  Note the time of the image at 0800 UTC is 4pm AWST. We have timed the Four-hour SST to catch peak
                  afternoon effect (0600 UTC on the east coast) because it can impact near-surface corals. Although the
                  heating is unlikely to cause any problems in winter, it is interesting to see the cooler outline of
                  Scott Reef (at approx. 122E and 14S) most likely due to the effect of tides.
                  <br />
                  &nbsp;
                </p>
                <p>
                  We have also re-designed the website so that choosing between our growing list of SST and
                  Chlorophyll-a products is easier. With the new navigator it is easy to flip between different types of
                  SST to compare and pick the best one for the job. The Four-hour SST is expected to be more reliable
                  and with less cloud than the Snapshot SST but because of the averaging the fronts will not be as
                  sharp. The 6-day SST is even more smoothed, being an average of all night-time data in a 6-day window.
                  We use the 6-day SST to calculate
                  <br />
                ...
                <p>
                  ...
                  'Permlink' button provides an way to send someone the link to an image. Of course, not all SST
                  products are available for all times. For example, at this stage, Four-hour SST is only available from
                  10 August 2017. Himawari-8 was launched in 2015 so eventually we will be able to backfill to 2015. We
                  have also included images of SSTAARS climatology (one per month) for each region.
                  <br />
                  &nbsp;
                  <br />
                  &nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  shelf indicates the existence of two types of fronts extending over 1000km from North-West Cape to
                  Cape Leveque. The nearshore band of high chlorophyl is associated with a
                ...
                <p>
                  On continental shelves, fronts can also develop just through the reduction of tidal currents with
                  depth without the influx of different water masses. Simpson and Hunter (1974)¹ showed that a front
                  could develop where mixing due to tidal currents was no longer strong enough to overcome
                  stratification. Many studies undertaken globally have shown that the ratio of the water depth to
                  nearbed current speed cubed, h/|U³| is a good indicator of the location of tidal fronts, in particular
                  where log10 (h/|U³|) = 2.7. The band of higher chlorophyll found further offshore, suggesting the
                  presence of a second front, lies in close proximity to the predicted Simpson and Hunter tidal front
                  location (indicated with black line). Coastal currents transporting different water masses can also
                  contribute to the existence of fronts and the frontal location could also be related to the location
                  of the Holloway current that flows towards the south-west. The offshore chlorophyll maximum, although
                  much weaker than in the nearshore front, has affected about 1000km of the mid-shelf region.
                  <br />
                  &nbsp;
                  <br />
                  Recent work by Thums et al. (2017)² demostrated that flatback turtles (<em>Natator depressus</em>)
                  followed the location of the predicted Simpson and Hunter tidal front when migrating along the
                  Kimberley Coast.
                </p>
                <p>
                  ...
                  <br />
                  ²Thums M, Waayers D, Zhi H, Pattiaratchi CB, Bernus J &amp; Meekan MG. 2017. Environmental predictors
                  of foraging and transit behaviour in flatback turtles (<em>Natator depressus</em>).
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  well away from land. This&nbsp;MODIS ocean colour image (click to expand)&nbsp;shows that Marcus left
                  a distinct trail in the ocean as it tracked west near latitude 15S and turned&nbsp;south near
                  longitude 108E. It appears that the winds (estimated to have reached 325km/h) and waves caused a lot
                  of vertical mixing, bringing nutrients and the deep layer of phytoplankton up to the surface. Apart
                  from coastal storm surge and a slight reduction of sea surface temperature along the path of the
                  cyclone, however, other ocean impacts are not obvious. Weaker, but slower-moving cyclones have had
                  more impact on the ocean.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  and the presence of a dense cold pool in the deepest part of Bass Strait is evident. The centre of
                  Bass Strait (right) is deeper than its surrounds and would have formed a large fresh-water lake
                ...
                <p>
                  During winter, strong winds and surface cooling create a well-mixed dense water mass in Bass Strait
                  that gradually becomes denser than water of the Tasman Sea to the east because the cooling is confined
                  to the depth of the strait. Once the density difference becomes large enough in the winter, the cold
                  dense pool exits Bass Strait as a bottom density current at the north-eastern side.
                  <br />
                  &nbsp;
                </p>
                <p>
                  This year, the Bass Strait glider has traversed the lake and found a cold, dense pool of water which
                  is low in oxygen, most likely a remnant of last winter. This bottom layer at 70-80 m was the portion
                  of Bass Strait water that could not exit last winter because of the 70 m deep ridge across the eastern
                  edge of Bass Strait. High chlorophyll-a indicates a bloom has occurred in the deep water where both
                  nutrients and some light are present. The oxygen maximum just above the interface shows the bloom is
                  growing. But once winter comes, they will be mixed to the surface and then flow northward out of Bass
                  Strait. Only the unlucky ones will get trapped for another summer - perhaps to be seen by the fourth
                  Bass Strait glider.
                  <br />
                  &nbsp;
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  forecast from the Bureau is still predicting a challenging wave field of 1.5-2m waves from the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Temperature image as well as geostrophic currents from altimetry. All three ocean observing systems
                  reveal the main flow of the East Australian Current separating from the shelf and heading off towards
                  New Zealand. Only the radar and the SST imagery, however, can resolve the details of the submesoscale
                  eddies between the EAC and the continental shelf.
                </p>
              </div>
            </article>
            <article className="p-2">
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  The University of Western Australia has provided the ocean forecast for race day and things are
                  looking complicated! For now, the forecast is for northward currents in the morning, changing to
                  southward flow by early afternoon. This is easy to see with the
                  <a href="http://rs-data3-mel.csiro.au/rottnest-swim-live/">swim optimiser</a>
                  and you can use the arrows on the optimiser to see the hourly forecast. The change in current
                  direction is due to a change in the wind direction. In fact, this year's forecast is different to any
                  other year because it's flipping between the
                  <a href="http://oceancurrent.imos.org.au/#20150213" className="anchor">
                  ...
                  currents giving swimmers a push towards Rottnest Island as the currents turn. We'll be keeping a eye
                  on the forecast and post an update if things change.
                  <br />
                  &nbsp;
                </p>
                <p>&nbsp;</p>
            ...
            <article className="p-2">
                ...
                <div>
                  <h3 id="Sea_Surface_Temperatures_around_Tasmania_reached_extremes_this_November_but_how_deep_did_the_heating_go">
                    <a
                      ...
                      className="anchor"
                    >
                      Sea Surface Temperatures around Tasmania reached extremes this November but how deep did the
                      heating go?
                    </a>
                  </h3>
                  <h5>
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  for the last 10 days of November, particularly to the west and south. Temperatures were hottest off
                  the northeast associated with a weak EAC eddy but more unusual were the high temperatures off the west
                  coast (see right) that also peaked at over 18°C, which is more than 3-4°C above the
                  ...
                  Cloud-free conditions allow maximum solar heating particularly at this time of year when UV radiation
                  is reaching its peak. SST indicates that off the west coast temperatures increased by up to 4°C over 3
                  weeks.
                </p>
                <p>
                  Satellite SST, however, is a measure of only a very thin surface layer (or surface skin) and when
                  winds are very weak there is not much vertical mixing and the SST may only represent a shallow surface
                  layer. Without modeling it is impossible to know how deep this surface layer extends. The unusual
                  weather conditions meant that not only was the sky around Tasmania cloud-free but the west coast, in
                  the lee of the wind, was almost becalmed as well (photo courtesy of Emlyn Jones, oceanographer and
                  self-described fishing tragic). The 'hot spot' off the west coast suggests that in this region the
                  heating may only be shallow. The consequence of shallow heating is not only that the extreme
                  ...
                  through November. The development of a warm mixed-layer throughout the month can be seen in the Argo
                  temperature profiles. The closest satellite SST for each profile is also plotted to indicate any
                  discrepancy between the surface and water below. In early November the water was well-mixed down to
                  60m and the Argo temperature at 5m was very close to the mixed layer temperature.&nbsp; For all days
                  the float profiled, the satellite SST was within 0.7°C of the temperature at 10m. After the weather
                  changed the surface heat was mixed down to 40m reducing the surface temperature significantly but
                  resulting in an increase of at least 2°C in the mixed layer since the beginning of November.
                </p>
                <p>
                  <img
                    alt=""
                  ...
                  <br />
                  <br />
                  Based on the SST anomalies, the west coast surface waters were 3-4°C above average for at least 10
                  days during November. From the Argo profile on Nov 24 it is clear the lack of wind was creating a
                  shallow surface layer so at the peak of the event it is most likely the sub-surface temperatures would
                  not have reached the 4°C anomaly but probably an anomaly of 3°C. In any case, with a 2° increase in
                  temperature of the top 40m, the event created a strong injection of heat into surface waters around
                  Tasmania. The system can be considered to have been primed so that a repeat period of cloudless
                  conditions, in the near future, could build on the heat that has been stored.
                  <br />
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  cold-core) eddy off north east Tasmania. This is quite likely to persist until race time, in which
                  case yachts sailing through its western side (presently on the rhumbline) may encounter adverse
                  currents of 1kt. If winds are light, this could be an important consideration. Conversely, favourable
                  currents may be found on the eastern side of the eddy – but that would require quite an extensive
                  detour off the rhumbline. It might be possible to avoid the adverse current by sailing very close to
                  land but that is difficult to assess, let alone foretell this far in advance.
                </p>
                <p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  Upwelled water has cooled the beaches along the coast of NSW from Coffs Harbour to southeastern
                  Victoria for more than two weeks. &nbsp;Beach water temperatures from Coffs to Jervis Bay have been
                ...
                <p>
                  Upwelling is a coastal response to an alongshore wind and off the NSW coast an upwelling favourable
                  wind is from the northeast. However, northeasterly winds in this region are relatively weak and short
                  lived so upwelling events often only occur when the EAC gives the wind an assist by lifting the cold
                  deep water closer to the surface. Throughout November, the EAC was close to the coast and a huge warm
                  core eddy was sitting offshore between Sydney and Jervis Bay but there wasn't any upwelling until the
                  ...
                  strongest in the southeast corner and through Bass Strait.&nbsp; Although a blocking high in the
                  Tasman is not at all unusual, it is unusual for one to stay for more than a week. This high stayed for
                  two weeks and in that time winds were persistently from the northeast quadrant all along the southern
                  NSW coast, decreasing northward. At the same time the EAC/eddy influence which was mostly from Jervis
                  Bay northward created conditions so that even weakly upwelling winds would bring cool water to the
                  surface.
                  <br />
                  <br />
                  <br />
                ...
                <p>&nbsp;</p>
                <p>
                  Along with the cold water, upwelling brings nutrients up to the surface where the phytoplankton can
                  use it and grow.
                  ...
                  contaminate the reading but in this case the colour is clearly associated with upwelling and indicates
                  a strong phytoplankton response along much of the coastline. For a rich ecosystem, a persistent
                  upwelling event is more important than a strong one as it allows the zooplankton time to respond to
                  the phytoplankton growth and in turn provide food for the next step in the food chain.
                  <br />
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Himawari-8 is Japan's advanced geostationary weather satellite that provides a 'full disc' scan of
                  Earth every 10 minutes. Fortunately for us, the centre of this view (at longitude 140.7°) is close to
                  us.&nbsp; The result is an SST product spanning 80°E to 200°E with a resolution (2-4 km at the
                  equator) that is nearly as good as the low-earth orbit NOAA satellites. Cloud is, of course, the bane
                  of observers of satellite SST and Himawari-8 cannot see through cloud, but with so many looks there is
                  a much better chance to piece together a clear view.
                </p>
                <p>
                  OceanCurrent has developed 4-hour composite SST* based on the Bureau of Meteorology's experimental
                  Himawari-8 product. The first images are very promising - the animated gif (right) of 48 hours of the
                  4 hour composites offshore from Perth shows tiny eddies, about 10km in diameter, being swirled around
                  the large cyclonic eddy in the centre of the image. There are also a couple of tiny eddies just to the
                  ...
                  available satellite SST (including NOAA15, NOAA18, NOAA19, VIIRS and MODIS) is used in the composites
                  to get the best coverage to the coast.
                </p>
                <p>&nbsp;</p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  of almost uninterrupted service since its launch in June 2008 until October 2016, when Jason-3 was
                  ready to take over the exact-repeat orbit. Jason-2 and Jason-3 are part of the Ocean Surface
                  Topography Mission (OSTM) that began when Topex/Poseidon was launched in September 1992 and completely
                  changed our knowledge and understanding of ocean variability. Ocean sea level height from satellite
                  altimeters is now an essential variable, routinely assimilated into global ocean models and wave
                  models. Sea level anomaly (SLA) from satellite altimetry (tracks are indicated on the SLA) also
                  provides the basis for knowing the
                ...
                <p>
                  ...
                  <br />
                  &nbsp; Importantly, the 10 day exact-repeat orbit of the OSTM provides the backbone for certainty in
                  our
                  ...
                  confidence and it relies on a short period of time when the two satellites follow the same orbit. So
                  far NASA and CNES have jointly managed to maintain an incredible 25 unbroken years but this time it
                  got a little close.
                  <br />
                  &nbsp;
                </p>
                <p>
                  ...
                  months before one of the gyroscopes that help maintain the satellite orbit and pointing started to
                  fail and steering became occasionally problematic. It has now been nudged 27 km lower than its
                  original altitude of 1,336 km so that should it fail it won't interfere with its successor. It has
                  been put into a 17 day almost-repeat orbit ensuring &nbsp;high quality global mesoscale coverage every
                  17 days but it will not be repeating the same track each cycle. Now that Jason-2 has handed the
                  reference orbit baton to Jason-3 it can provide data in new regions of the ocean, in between the
                  reference tracks, to improve and fill the gaps of bathymetry and mean sea surface. The longer it
                  spends in this new orbit the more improvement it will bring to geophysical applications while still
                  fulfilling the operational oceanography needs.
                  <br />
                  &nbsp;
                  <br />
                  &nbsp;
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  imagery (chlorophyll, SST and surface current). A 2014 trip by a male New Zealand Fur Seal from
                  Montague Island to Jervis Bay – the long way - is particularly intriguing. The image at
                  right&nbsp;shows the final 2 days of his trip around a warm-core, low surface chlorophyll eddy of the
                  East Australian Current. His voyage started on 8 September and if you step through
                  ...
                  down to 100m to&nbsp; check the stratification. Is the edge of the eddy better fishing? Does he like
                  the
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  that the event was most likely due to the extreme temperature change associated with the upwelling
                  event off East Gippsland. Fishers reported a sharp 'temperature break' with 25° clear water alongside
                  16°C cloudy water, evidence of which could be seen from the air on March 31. Since then there have
                  been reports of leatherjackets washing up in large numbers on Tasmanian beaches all along the eastern
                  coastline,
                ...
                <p>
                  ...
                  probably see more of them on Tasmanian beaches. Apparently, though, even last weekend there were still
                  a lot of leatherjackets that hadn't yet succumbed to the cold. CSIRO oceanographer, Alistair Hobday,
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  black sole, puffer fish, boxfish, sea urchins, flathead and even some penguins.
                  <a
                ...
                <p>
                  ...
                  <a href="http://oceancurrent.imos.org.au/daily.php?link=DR_SST_daily/SST/Syd-Hob/20170308.gif">
                    Mar 8
                  </a>
                  ...
                  These images also show the water offshore is a warm 22°C and at times is separated by only 25km from
                  the 14°C upwelled water. The
                  ...
                  while the EAC waters just offshore were in the top 10% of temperatures. Colder upwelled water implies
                  a higher nutrient concentration as it is likely to have come from deeper in the water column. Warm EAC
                  ...
                  <br />
                  <br />
                  The cause of the fish deaths is still to be established but could include hypoxia caused through
                  oxygen depletion when the algae die off or suffocation due to the algae blocking the fish gills or
                  even shock due to the rapid change in temperature. The Victorian EPA is investigating the event to
                  determine the exact cause of the deaths and the various factors could be complex. Whatever the cause
                  of this fish kill it appears that
                  <a href="http://oceancurrent.imos.org.au/#20160825" className="anchor">
                    increased southward extension of the EAC
                  </a>
                  that has become apparent since at least 2014 has contributed to creating both a stronger upwelling
                  event and higher gradients in temperature.
                  <br />
                  &nbsp;
                </p>
                <p>
                  *Roughan, M.<cite>, and</cite> J. H. Middleton <cite>(</cite>2004<cite>)</cite>
                  <cite>, </cite>On the East Australian Current: Variability, encroachment, and upwelling<cite>, </cite>
                  J. Geophys. Res.<cite>, </cite>109<cite>, </cite>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  can help you with that.&nbsp; The good news is that the Bureau of Meteorology is forecasting weak
                  winds from the east so the sea chop should not affect your swim time. Of course, our advice is based
                  on forecasts which may turn out to be different on the day so all swimmers are advised to adjust their
                  plan to the conditions on the day. Good luck to all swimmers from the OceanCurrent team!
                  <br />
                  &nbsp;
                </p>
              </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  The ocean forecast for the Port-to-Pub swim on Saturday is for strong and persistent northward
                  currents, weakly northward near Freemantle but ramping up to almost 1kn about half way through the
                  crossing. There is also predicted to be a slight shoreward push in the currents, which will make the
                  swim take that little bit longer. It's early days yet though and the
                  <a href="http://rs-data3-mel.csiro.au/porttopub-swim-live/">swim-optimizer</a>
                ...
                <div className="row">
                  <div className="col-md-6">
                    <p>
                      ...
                      throughout the day, particularly near Rottnest Island. So at this point, our advice is to stay
                      close to the northern buoys, throughout the race, particularly those swimmers who will still be in
                      the water after 11am. Winds are expected to be light and from the north-east. You can
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  wind. The first image at right (click to expand) shows the cooler coastal temperatures that we often
                  see under these conditions and associate with reduced southward speed. This eddy has been off Sydney
                  since about
                  <a href="http://oceancurrent.imos.org.au/SE/20161207.html">7 Dec</a>
                  and is quite likely to still be there on race day.
                </p>
                <p>
                  The first image at right also shows a small clockwise eddy south of Jervis Bay. This will either grow
                  in place or be swept southwards in coming days. In either case, it will mean that inshore and offshore
                ...
                <p>
                  ...
                  Currents east of Bass Strait do not appear to be particulary strong this year. The rhumbline (2nd
                  image at right) presently cuts across a large but fairly weak clockwise eddy that is likely to persist
                  until race day.
                </p>
                <p>
                ...
                <p>
                  We wish the competitors a safe but exciting race, and cross our fingers that our computers keep
                  running unattended through our Christmas Shutdown. If our images stop updating, it probably means
                  there has been a power interruption in Hobart.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  The IMOS Animal Tracking Facility has deployed over 250 SealCTDs (miniaturized CTD sensors with an
                  ARGOS antenna) on Elephant Seals, Sea Lions, Fur Seals and Weddell Seals since 2009. The data can now
                  be viewed on OceanCurrent. The original motive for the sensors was to provide information about animal
                  behaviour but the physical data they have collected has already been valuable in studies of Antarctic
                  bottom water formation, the global heat budget, Southern Ocean frontal structure and sea ice
                  formation.
                </p>
                <p>
                  <br />
                  ...
                  profile from the deepest dive over the last 6 hours. In order to prolong battery life and to ensure
                  the whole profile is transmitted before the seal dives again, the profile is also compressed (by
                  calculating break-points) before transmission. The SealCTD (or tag) is glued onto the animal's head
                  and drops off during their moult.
                  <br />
                  <br />
                  ...
                  her tag in the melting ice. The time series are also plotted in 10 day sections with the seal's
                  location indicated.&nbsp;
                  <br />
                  &nbsp;
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  Around the globe 2015 was an exceptionally warm year for both land and ocean temperatures. For
                  Tasmania though, the heat continues with sea surface temperatures off the east coast hotter than ever
                  this year. Much of the warming can be attributed to the unusual presence of EAC eddies south of Bass
                  Strait. For example (right) the eddy off NE Tasmania encountered by the
                ...
                <p>
                  ...
                  (red line). Prior to the 1990s few eddies got past Bass Strait. After the 1990s EKE increased
                  gradually both north and south of Bass Strait. In the summer of 2014, Tasmanian waters saw a huge
                  spike in eddy activity (8 times the average EKE of the 1990s) and since then it has peaked a number of
                  times to levels much higher than those seen before 2014. In that time, EKE in the EAC extension has
                  also increased, consistent with an
                ...
                <p>
                  The influence of these eddies goes well beyond the sea surface temperature. Argo floats sampled the
                  eddy pictured above both at its centre and at its outer edge near the continental slope. Temperatures
                  at the centre of the eddy were more than 2° warmer than the year round average between 100 and 400m
                  depth and almost 1° warmer down to 1200m depth. How much the eddy properties impinge on the shelf is
                  highly dependent on the size and path of each eddy but with their greater frequency and size, these
                  eddies will inevitably impact coastal waters.
                  <br />
                  <img
                    alt=""
                ...
                <p>
                  ...
                  . The eddy velocities of over 2 knots (Rudy Kloser, pers comm) persisted for much of the survey² in
                  July this year. How the spawning ground preference and larvae are impacted by the increased
                  temperatures and velocities due to the eddies is unknown at this stage but given that it has occurred
                  now two years in a row we may well find out in the future.
                  ...
                  point we cannot be sure. Impacts on the state's aquaculture and fisheries are similarly unclear at
                  this point but it does appear that the risk of a continuation of recent trends should be taken
                  seriously.
                  <br />
                  <br />¹ Eddy kinetic energy was estimated using geostrophic currents from the IMOS OceanCurrent
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  (SOI) have been in the El Niño phase for almost 2 years but they have both just moved weakly into the
                  La Niña phase and everyone is waiting to see what the future holds.&nbsp;
                  <br />
                  <img
                    alt=""
                ...
                <p>
                  ...
                  particularly during
                  <a href="http://www.bom.gov.au/climate/enso/ninacomp.shtml">winter and spring</a>. For Australia, the
                  La Niña event of 2010-2011 was one of the strongest on record, bringing devastating floods to
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  height of the waves. The East Coast Low that has brought flooding to parts of Qld, NSW and Tasmania
                  has also
                ...
                <p>
                  ...
                  wavewatch3 forecast heights in the Tasman Sea on 6 June (right). The wave field changes quite quickly
                  so we don't expect a perfect match as the altimeter passes included in this plot are up to 9 hours
                  after and 7 hours before the forecast. The satellite wave measurements complement in-situ wave
                  measurements (e.g., the NSW Manly Hydraulics Lab waverider buoys), by resolving the spatial
                  variability of the wave field over a larger domain. Together, they are used to assess and ultimately
                  improve wave forecast models.
                </p>
              </div>
            </article>
            <article className="p-2">
                ...
                <div className="row">
                  <div className="col-md-7">
                    <p>
                      ...
                      has been reported from the Northern to the Central Great Barrier Reef (GBR). The main cause of
                      coral bleaching is persistently high sea temperatures. This bleaching event has coincided with a
                      marine heat wave on the GBR where the monthly average sea surface temperature (SST) anomaly for
                      March was greater than 1º for much of the Central GBR, and reaching 2º for much of the Northern
                      GBR.
                      <br />
                      &nbsp;
                    </p>
                    ...
                    <p>
                      Since October 2015, IMOS and CSIRO Slocum gliders have traversed this region, tracking the
                      seasonal evolution of coastal waters. The intensive missions were principally planned to help
                      validate the <a href="https://research.csiro.au/ereefs/">eReefs</a> model but have also provided
                      unprecedented observations of the formation, persistence and now waning of the thermal stress of
                      the GBR waters. Glider pilots remotely navigate the gliders through complex pathways between
                      reefs, which can be challenging with strong currents and tides. Gliders are capable of making
                      observations in places difficult for ships and can stay at sea for several weeks. By sampling the
                      water in see-saw manner, the gliders can reveal how deep the warming extends. By April 2016,
                ...
                <div className="row">
                  <div className="col-md-7">
                    <p>
                      ...
                      , in which cooler water lifts up onto the shelf from offshore. This cool water may provide relief
                      to marine ecosystems sensitive to the marine heatwave. SST from 27 March (below) indicate the
                      outer reef of the Northern GBR, 2-3 degrees cooler, than the inner reef, may be buffered by a
                    ...
                    <p>
                      ...
                      autumn causes waters to cool and become more dense near the coast. Both cascades occurred nearly
                      ...
                      south of Cairns. These cascades flow offshore and can cool the communities living near the sea
                      bed. Ongoing glider deployments into winter will inform how long the warming lasts.
                    </p>
                  </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <a href="http://onlinelibrary.wiley.com/doi/10.1029/2012GL053091/abstract">“Eddy Avenue”</a>, from
                  their formation region down to Tasmania. They can bring
                ...
                <p>
                  ...
                  This means that the EAC water trapped inside these eddies can reach regions farther than expected.
                  These results suggest that warm core eddies can carry heat and salt from the tropics all the way to
                  the Great Australian Bight. These warm core eddies rotate at ~20 cm/s at formation and propagate at
                  3-8 cm/s. They can live up to 4 years before slowing down and dissipating completely.
                  <br />
                  &nbsp;
                  <br />
                  Recently, since February, a warm core eddy carrying surface waters of 18ºC has been slowly cruising
                  along the Eastern Tasmanian coast. This eddy has a diameter of ~250 km and could be as deep as 1000
                  km. That is equivalent to 6.5 Sydney Towers! Now, the eddy is about to move beyond Tasmania's southern
                  tip and continue its journey to the far west&nbsp; (bottom figure).
                  <br />
                  &nbsp;
                  <br />
                  <img
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  cooler mid-latitudes. Satellite observations show the spatial extent and variability at the surface
                  but the subsurface velocities and properties can extend to depths of thousands of meters and remain
                  largely unknown.
                </p>
                <p>
                  Data from the first deployment, April 2012-August 2013, reveal the complexity and dynamic nature of
                  the EAC, including the offshore return flow and the episodic nature of the deep northward
                  undercurrent. The EAC array was designed to capture the entire breadth and depth of the flow. For this
                  reason it was placed off Brisbane where the current is almost at full strength and still in jet form
                  rather than as a complex eddy field found further south. Even so, there are a few days in June 2012
                  when a rarely occurring eddy pushes the main stream of the EAC further offshore than the 150km extent
                  of the array.
                ...
                <p>
                  ...
                  Tidal signals have been filtered out and for ease of interpretation the data have been interpolated
                  onto a regular grid (10m vertical, 2km horizontal resolution).&nbsp; These data provide a significant
                  advance in our understanding and begin to expose the complexity of the system. The original dataset is
                  available for download from IMOS.&nbsp;Further details of the deployment, initial results and data
                  preparation are presented in
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  The inaugural Port to Pub race, from Fremantle to Rottnest, is on this Saturday and we have adjusted
                  our
                  <a href="http://rs-data3-mel.csiro.au/porttopub-swim/" target="_blank" rel="noreferrer">
                    swim optimizer
                  </a>
                  to help swimmers make the ocean work for them.&nbsp; The forecast is in and, as for the Rottnest swim
                  in February, conditions are looking good for a fast swim. The currents are forecast to be weak (less
                  than half a knot) and the winds from the east so the waves will be small. The hourly forecast velocity
                  ...
                  swimmers will feel the effects of a weak southward flow, which is expected to develop from 1pm
                  onwards.
                </p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  <div className="col-md-6">
                    <p>
                      Today's updated forecast is for weaker northward currents than previously forecast and only
                      occuring in the morning. Later in the day, the forecast is for westward flow providing a small
                      boost to slower swimmers and those starting in the later wave times. The westward flow, however,
                      is highly dependent on small scale weather features which are hard to predict.
                    </p>
                    <p>
              ...
              <div className="flex items-center justify-between rounded bg-[#F1F6F9] p-4">
                <div>
                  <h3 id="The_Bonney_Coast_Upwelling_biological_hotspot_sampled_by_an_IMOS_glider">
                    <a
                      href="#The_Bonney_Coast_Upwelling_biological_hotspot_sampled_by_an_IMOS_glider"
                      className="anchor"
                    >
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  ...
                  <p>
                    ...
                    bio-physical properties of a&nbsp;Bonney Coast upwelling event. The dissolved oxygen data are
                    perhaps the most exciting: percent saturation values exceeded 150 within the upwelled water on 3
                    Feb, confirming that the phytoplankton were very actively photo-synthesizing, producing much more
                    oxygen than was lost to the atmosphere. You can step through the mission seeing either
                    <a
                  ...
                  <p>
                    ...
                    bio-fouling. The present mission DO data are not suspicious, because the high readings occurred
                ...
                <div className="row">
                  ...
                  <p>
                    ...
                    MODIS estimates of chlorophyll-a show that the present event is not an extraordinary one. The track
                    of the glider can be seen in the image at left as a blue line at bottom right. See also the
                    chlorophyll-a images for
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  the Sydney-Hobart yacht race will encounter. The cold eddy is off Sydney-Jervis Bay and tending to
                  block the southward flow of warm East Australian Current water. If it has moved little, or west since
                  this 18 Dec image was acquired then yachts may encounter very little current during the first section
                  of the race. South of Jervis Bay, however, the situation is probably very different, because of the
                  detached warm-core eddy off southern NSW, where yachts are likely to find strong tail-current. The
                  third player is the large, but possibly not very energetic, warm-core eddy spanning much of Bass
                  Strait as well as much of the east coast of Tasmania. In between, or embedded within, these large
                ...
                <div className="row">
                  <div className="col-md-6">
                    <p>
                      ...
                      'godzilla' El Niño is responsible for much of the warming in the equatorial Pacific, but the
                      Indian Ocean has been quite warm too. Both oceans contribute to Australia's climate and a record
                      warming year could have dire consequences for already dry regions of our continent and our
                      neighbours.
                    </p>
                    <br />
                    <img
                  ...
                  <div className="col-md-6">
                    <p>
                      ...
                      (red contours in plot). In fact this year, more of the ocean has broken records than any other
                      year since 1981.
                      <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  conducted in the wrong area. This speculation rests on modelling that suggested that the flaperon
                  found on La Reunion on 29 July 2015 probably entered the ocean more than 1000km north of the present
                  sea floor search area. This speculation is at odds with CSIRO, who concluded that the finding of the
                  flaperon “did not cast doubt” on the sea-floor search area.
                </p>
                <p>
                  The difference of opinion depends on whether the flaperon is assumed to drift at the average velocity
                  of the ocean's surface mixed-layer, or whether winds and waves impart an additional velocity. CSIRO
                  argue that the effect of winds and waves cannot be ignored, because the flaperon must have floated
                  within the uppermost few meters of the ocean, where it would have been subject to the Stokes drift, no
                  matter how little freeboard it had to prevent it from sinking.
                </p>
                <p>
                  ...
                  drifters inevitably lose their drogues, at which point, argue CSIRO, their trajectories become the
                  best available guide to the likely drift of the flaperon. But the number of drifters traversing the
                  Indian Ocean in the last 30 years is not large, especially if the data set is sub-setted for the times
                  of year appropriate to the drift of the flaperon. Joining near-intersecting trajectories together,
                  however, provides a much larger number of 508d-long trajectories, which is how long the flaperon was
                  in the water.
                  <br />
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  Pacific become sufficiently warm that the atmospheric circulation shifts resulting in weaker
                  equatorial trade winds. Low sea levels north of New Guinea (a result of weak equatorial trade winds)
                  are strongly correlated with Nino3.4, the El Niño index that relates best to Australian climate.
                  <br />
                  &nbsp;
                </p>
                <p>
                  ...
                  shows the June 2015 SLA for the Australasian region, while the time-series below shows that the
                  average for the region north of PNG &nbsp;(boxed on the map) has only been lower once before since
                  1992 when satellite sea level observations commenced.
                  <br />
                  ...
                  . There is a two month delay between the sea level anomaly off Perth and the region north of New
                  Guinea. The low sea level signal propagates southward along the west coast of Australia weakening the
                  Leeuwin Current and causing water temperatures to be cooler.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  <br />
                  principal objective of the voyage was an ambitious one: to locate then study the ecological role of
                  one or more frontal eddies. Frontal eddies&nbsp;
                  <br />
                ...
                <p>
                  ...
                  voyage, and since an extraordinary example of a large cold-core eddy happened to be off Brisbane at
                  the start of the voyage, <em>Investigator</em> sampled it from 3 June to 6 June, as shown at right.
                  Note the northward flow where the EAC normally flows southward along the continental margin.
                </p>
                <p>
                  On&nbsp;
                  ...
                  several transects of it had been completed, delivering a wealth of information from the ship's suite
                  of sensors and nets. As anticipated, the ship recorded elevated levels of
                ...
                <p>
                  ...
                  <em>OceanCurrent</em> depends for sea level information) overflew the centre of the freddy on 9 June,
                  so the matchup of ship and satellite observations will help us interpret the combined dataset in the
                  light of the historical archive of altimetry. The freddy is too small to be resolved in our 2D gridded
                  maps but the central depression of 15cm is clear in the raw along-track data, consistent with ship
                ...
                <div className="row">
                  ...
                  <div className="col-md-9">
                    <p>
                      ...
                      cascade' water at a surprising number of locations over the continental shelf. These dense pools
                      of shelf water have increasingly been revealed with the high-resolution repeat sampling possible
                      with ocean gliders.
                    </p>
                    ...
                    <p>
                      ...
                      around Australia (Spencer Gulf, Two Rocks in WA, the Kimberley and Yamba NSW) have all just
                      recently encountered dense shelf water pools. How do we distinguish the winter cascade from
                      upwelling? Its not always clear-cut, but distinguishing features of winter cascade are that 1) the
                      coldest, saltiest water is at the coast, 2) it usually occurs on a wide shallow shelf and 3) it is
                      found after cold winds occur, typically off the land, rather than from the upwelling-favourable
                      direction.
                    </p>
                  </div>
                </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                <div className="row">
                  ...
                  <div className="col-md-8">
                    <p>
                      Early analysis of the warm SST in the North East Pacific is showing temperature anomalies
                      exceeding 4 standard deviations above the mean. This warming began in 2013 and it has been
                      suggested that this may be a new sort of phenomenon not seen before in modern records
                      (http://www.oceannetworks.ca/warm-northeast-pacific-ocean-conditions-continue-2015). Given there
                      is such a significant warming over a long time period, will this have any effect on Australia and
                    ...
                    <p>
                      ...
                      suggest, however, that the PDO or ENSO were drivers of this exceptional warming. Early analysis
                      and discussion on forums are linking this warming to a weaker than average Aleutian Low pressure
                    ...
                    <p>
                      ...
                      of other climate modes such as ENSO and the PDO, particularly through changes in the strength of
                      the Aleutian Low. Without historical analogues it is difficult to anticipate how the coming year
                      will play out and whether this warming amplifies later this year if an El Niño develops.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  depending on the influence of winds and ocean currents. The MODIS satellite image for 25 April says
                  much about the way dispersal works in the ocean. A thin tendril of floodwater, coded yellow-orange in
                  this image, can be seen stretched out along the boundary that already existed between the
                  low-chlorophyll waters of the East Australian Current (coded blue) and the Tasman Sea waters shown in
                  green. Most of the buoyant plume was still close to the coast on 25 April, its seaward edge marked by
                ...
                <p>
                  ...
                  to see the glider encounter, then depart from, the buoyant pool of floodwaters. The observations
                  ...
                  show how the seaward edge of the plume is over-ridden by the EAC water because the temperature effect
                  on density is winning against the freshness effect. High estimates of Coloured Dissolved Organic
                  Matter (CDOM, shown on the
                  <a href="http://anfog.ecm.uwa.edu.au/index.php" target="blank">
                    ANFOG site
                  </a>
                  ) in the low-salinity water suggest that the MODIS estimates of Chlorophyll are probably being
                  'tricked' by high levels of CDOM as well as by the suspended sediments, but nevertheless, can be used
                  to monitor the dispersal of floodwaters. One very important consequence of the runoff may be the input
                  of nutrients (nitrate, phosphate and silicate) to the Tasman Sea ecosystem. A bloom of diatoms (the
                  preferred prey of many zooplankton, but rarely abundant off NSW) may result from this flood. Shown at
                  right is the diatom
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  the Spring Persistence Barrier) until sometime in June or July. Nevertheless, all the signs are there.
                </p>
                <p>
                  ...
                  the event. Often this can occur when a Madden Julian Oscillation (MJO) develops over the western
                ...
                <p>
                  ...
                  predicted with a 70% chance of occurring. The warm anomalies dissipated however, though the reasons
                  why are still being explored.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  (low-chlorophyll) waters of Australia's warm, southward-flowing boundary currents and
                  higher-chlorophyll coastal waters that are being drawn offshore by the meanderings of those boundary
                  currents.
                </p>
                <p>
                ...
                <p>
                  Off Sydney, three IMOS current meter moorings recorded northward motion of the inner-shelf waters on
                  18 Dec 2013. This is something our estimation of geostrophic velocities is blind to, but is key to
                  understanding the way the eddy-shedding process of the East Australian Current and shelf-slope
                  exchange are linked.
                </p>
              </div>
            </article>
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  destruction in Queensland and the Northern Territory and, as usual, the question is whether anomalous
                  ocean temperatures contributed to their strength.
                </p>
                <p>
                  ...
                  , like the satellite images of surface temperature, were close to normal off NE Australia. The areas
                  of significant temperature anomalies (not all positive) were farther west and/or south. The most
                  conspicuous of these are the positive anomalies off the NW and SE, and some isolated negative
                  anomalies near the coast.
                </p>
                <p>
                  The
                  <a href="https://oceancurrent.aodn.org.au/sst.php?link=TasE/2015/2015022208.html">Tasmanian</a>
                  anomaly is mainly due to the East Australian Current continuing to bring more warm water southwards
                  than usual (see
                ...
                <p>
                  ...
                  , on the other hand, has had strong wind-driven upwelling since mid-January. Cold water due to
                ...
                <p>
                  Less commonly observed are the relatively cold shelf temperatures seen several times this summer as
                  far north of
            ...
            <article className="p-2">
              <div className="flex items-center justify-between rounded bg-[#F1F6F9] p-4">
                <div>
                  <h3 id="Northward_Currents_predicted_and_observed_for_the_Rottnest_Channel_Swim">
                    <a
                      href="#Northward_Currents_predicted_and_observed_for_the_Rottnest_Channel_Swim"
                      className="anchor"
                    >
              ...
              <div className="rounded-b bg-white p-4">
                <p>
                  ...
                  northwards while the currents off the continental shelf were going southwards, as is often the case.
                  The radar does not have such fine spatial detail as the model but does confirm the general pattern, as
                  well as the increasing northward velocities that were forecast. See also the
                  ...
                  these reversals, and is not yet available for the day of the race. The thermal image confirms the
                  usual association of northward winds and flow with upwelling of waters from depth.
                </p>
                <div className="col-md-4">
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  The
                  <a href="http://www.oceans.uwa.edu.au/">Oceans Institute of the University of Western Australia</a>
                  ocean current forecast is for northward currents throughout the race, weak near the coast and
                  strongest (0.25 m/s at midday) after the 15 km mark, as shown in the images below.
                </p>
                <p>
                  Northward currents are anticipated to increase from midday due to the sea breeze, making the approach
                  to the island most difficult near the cutoff time.
                </p>
            ...
            <article className="p-2">
              ...
              <div className="rounded-b bg-white p-4">
                ...
                <p>
                  ...
                  dominated by the land/sea breeze system. In the morning, the wind is easterly (i.e. blows from the
                  land to the ocean). During the late morning to early afternoon, the sea breeze changes direction to
                  blow from the south or south-southwest. The sea breeze is usually both much stronger and longer
                ...
                <p>
                  The next most common weather pattern for the region features strong easterly winds. The current at
                  these times flows southwards (below right). This happens when we have several really hot days (i.e.
                  high 30's+) in a row. This is what happened in
                ...
                <p>
                  The current accelerates locally as it flows around Rottnest Island, so currents are stronger along
                  both ends of the island. As the swimmers start off from Cottesloe, the currents will probably be weak
                  and not have much influence. However, as the swimmers get closer to Rottnest Island (about 2-3 km
                  away) they are more likely to experience strong currents. The direction of the currents would depend
                  on the prevailing wind conditions (see above). These currents may be strong (up to 1 knot or 0.5 m/s).
                </p>
              </div>
            </article>
          </div>
