...
(() => {
  ...
  (i.m = r),
    ...
    (i.u = (e) => ({ 212: 'nr-spa-compressor', 249: 'nr-spa-recorder', 478: 'nr-spa' })[e] + '-1.297.1.min.js'),
    ...
    (() => {
      ...
      var t = (t, r) => {
        ...
        r = (self['webpackChunk:NRBA-1.297.1.PROD'] = self['webpackChunk:NRBA-1.297.1.PROD'] || []);
    ...
    (() => {
      ...
      class E extends v.W {
        ...
        importAggregator(e, t, r = {}) {
          ...
          const o = async () => {
            ...
            try {
              if ((0, R.V)(e.init)) {
                const { setupAgentSession: t } = await i.e(478).then(i.bind(i, 2955));
                o = t(e);
              }
            } catch (e) {
              (0, l.R)(20, e),
      ...
      class j extends E {
        ...
        constructor(e) {
          super(e, P.T),
            y.RI &&
              ((0, O.u)(() => (0, s.p)('docHidden', [(0, c.t)()], void 0, P.T, this.ee), !0),
      ...
      function K(e) {
        if (e.error instanceof SyntaxError && !/:\d+$/.test(e.error.stack?.trim())) {
          const t = new M(e.message, e.filename, e.lineno, e.colno, e.error.__newrelic, e.cause);
      ...
      class q extends E {
        ...
        constructor(e) {
          ...
          this.ee.on('internal-error', (t, r) => {
            this.abortHandler &&
              (0, s.p)('ierr', [H(t), (0, c.t)(), !0, {}, e.runtime.isRecording, r], void 0, this.featureName, this.ee);
          }),
        ...
        constructor(e) {
          ...
          he(this.ee),
            ...
            (function (e, t, r, i) {
              ...
              function a(e) {
                (this.params = { method: e[0] }), Ee(this, e[1]), (this.metrics = {});
              }
              function u(t, r) {
              ...
              function d(e, r) {
                ...
                for (var s = 0; s < ye; s++) r.addEventListener(be[s], this.listener, (0, I.jT)(!1));
              }
              function l(e, t, r) {
                (this.cbTime += e),
              ...
              function x(e, t) {
                ...
                'string' == typeof i
                  ...
                  Ee(this, r);
                var o = ('' + ((i && i instanceof we && i.method) || n.method || 'GET')).toUpperCase();
              ...
              function E(e) {
                ...
                if (!this.ended) {
                  this.ended = !0;
                  for (let t = 0; t < ye; t++) e.removeEventListener(be[t], this.listener, !1);
                  t.aborted ||
                    (0, ve.iW)(t) ||
              ...
              function A(e, r) {
                ...
                if ((i && (e.metrics.rxSize = i), e.sameOrigin && r.getAllResponseHeaders().indexOf(xe) >= 0)) {
      ...
      function _e(e) {
        ...
        return !y.RI || Ae[t.debugId]++ || ((Ae[t.debugId] = 1), (0, re.YM)(t).inPlace(window.history, Se, '-')), t;
      }
      var Ne = i(3738);
      function Oe(e) {
        p(
      ...
      const { He: Ie, bD: Pe, d3: je, Kp: ke, TZ: Ce, Lc: Le, uP: Me, Rz: He } = Ne;
      class De extends E {
      ...
      class Ue extends E {
            ...
            this.ee.on('err', (e) => {
              this.blocked ||
                (this.agentRef.runtime.isRecording &&
                  ((this.errorNoticed = !0),
                  (0, s.p)(Ke.G4.ERROR_DURING_REPLAY, [e], void 0, this.featureName, this.ee)));
            });
        }
        #o(e) {
          return (
        ...
        #i() {
          this.blocked ||
            (this.featAggregate
              ? this.featAggregate.mode !== S.g.FULL && this.featAggregate.initializeRecording(S.g.FULL, !0, Ke.Qb.API)
      ...
      class Be extends E {
        ...
        constructor(e) {
          if ((super(e, Fe.TZ), We(e), !y.RI || !(0, N.dV)().o.MO)) return;
          const t = _e(this.ee);
          Fe.tC.forEach((e) => {
            (0, I.sp)(
              e,
      ...
      const { TZ: ot, d3: at, Kp: st, $p: ct, wW: ut, e5: dt, tH: lt, uP: ft, rw: ht, Lc: pt } = Ge;
      class gt extends E {
        ...
        constructor(e) {
          ...
          this.ee.on(ft, m),
            ...
            u.buffer(['setTimeout' + st, 'clearTimeout' + at, ft], this.featureName),
            d.buffer([ft, 'new-xhr', 'send-xhr' + at], this.featureName),
            f.buffer([lt + at, lt + '-done', lt + ct + at, lt + ct + st], this.featureName),
            h.buffer(['newURL'], this.featureName),
            p.buffer([ft], this.featureName),
            a.buffer(['propagate', ht, ut, 'executor-err', 'resolve' + at], this.featureName),
      ...
      class vt extends E {
        ...
        constructor(e) {
          ...
          if (
            ...
            y.RI &&
              (e.init.user_actions.enabled &&
                (mt.Zp.forEach((e) => (0, I.sp)(e, (e) => (0, s.p)('ua', [e], void 0, this.featureName, this.ee), !0)),
                mt.qN.forEach((e) => {
                  const t = (0, x.s)(
                    (e) => {
      ...
      function wt(e, t, r, n) {
        ...
        return yt.set(s, a), o.inPlace(t, [r], 'wrap-logger-', () => yt.get(s)), i;
      }
      var Rt = i(1910);
      class xt extends E {
        ...
        constructor(e) {
          ...
          ['log', 'error', 'warn', 'info', 'debug', 'trace'].forEach((e) => {
            (0, Rt.i)(y.gm.console[e]), wt(r, y.gm.console, e, { level: 'log' === e ? 'info' : e });
          }),
      ...
      })({ features: [Te, _, j, De, Ue, k, q, vt, xt, Be, gt], loaderType: 'spa' });
    })();
})();
