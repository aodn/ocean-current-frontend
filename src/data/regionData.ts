...
const localRegions: LocalRegion[] = [
  ...
  {
    code: 'NingLeeu',
    title: 'Ningaloo-Leeuwin',
    coords: [109.2 - 1.0, 116.6, -34.5, -21],
  },
  {
    code: 'NZNI',
    title: 'New Zealand North',
    coords: [170.0, 180.0, -42.0, -33.0],
  },
  {
    code: 'NZSI',
    title: 'New Zealand South',
    coords: [164.0, 177.0, -48.0, -39.0],
  },
  ...
  { code: 'PNGSol', title: 'PNGSol', coords: [140, 165, -14, 0] },
  {
    ...
    coords: [124, 136.5, -38.1, -31.3],
  },
  {
    code: 'Rottnest',
    title: 'Rottnest Is.',
    coords: [114.4, 116.2, -33.1, -31.6],
  },
  { code: 'Rowley', title: 'Rowley', coords: [116, 124, -21, -14] },
  {
    code: 'RowleyAtolls',
    title: 'RowleyAtolls',
    coords: [118.5, 120.5, -18.5, -16.5],
  },
  { code: 'SAgulfs', title: 'SA gulfs', coords: [134, 141.3, -39.5, -34.2] },
  {
    code: 'ScottMore',
    title: 'ScottMore',
    coords: [121.5, 124.0, -14.5, -11.3],
  },
  ...
  {
    code: 'TimorP',
    title: 'Timor Passage-Darwin',
    coords: [122.6, 132.6, -14.5, -7.5],
  },
...
const sealCtdRegions: (LocalRegion | StateRegion)[] = [
  { code: 'POLAR', title: 'Antarctica', coords: [-180, 180, -80, -60], scope: RegionScope.State } as StateRegion,
  { code: 'GAB', title: 'GAB', coords: [131.2, 141, -39, -31], scope: RegionScope.Local } as LocalRegion,
...
const convertedSealCtdRegions: (LocalRegion | StateRegion)[] = sealCtdRegions.map((region) => ({
  ...region,
  coords: convertOldOceanCurrentCoordsToBBox(region.coords),
}));
