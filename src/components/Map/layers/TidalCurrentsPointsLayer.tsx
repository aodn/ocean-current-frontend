...
interface TidalCurrentsPointsLayerProps {
  isMiniMap: boolean;
  isArgo: boolean;
}
...
const TidalCurrentsPointsLayer: React.FC<TidalCurrentsPointsLayerProps> = ({ isMiniMap, isArgo }) => {
...
export default TidalCurrentsPointsLayer;
